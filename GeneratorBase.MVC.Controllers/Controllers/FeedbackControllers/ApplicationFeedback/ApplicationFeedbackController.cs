...
public partial class ApplicationFeedbackController : BaseController
{
    ...
    ///
    /// <param name="lstApplicationFeedback">The list application feedback.</param>
    ...
    /// <param name="associatedapplicationfeedbacktype">    The associatedapplicationfeedbacktype.</param>
    /// <param name="associatedapplicationfeedbackstatus">  The associatedapplicationfeedbackstatus.</param>
    /// <param name="applicationfeedbackpriority">        The applicationfeedbackpriority.</param>
    /// <param name="applicationfeedbackseverity">        The applicationfeedbackseverity.</param>
    /// <param name="applicationfeedbackresource">        The applicationfeedbackresource.</param>
    ///
    ...
    /// <summary>GET: /ApplicationFeedback/FSearch/.</summary>
    ///
    ...
    /// <param name="applicationfeedbackseverity">        The applicationfeedbackseverity.</param>
    /// <param name="applicationfeedbackresource">        The applicationfeedbackresource.</param>
    /// <param name="CommentIdFrom">                      The comment identifier from.</param>
    /// <param name="CommentIdTo">                        The comment identifier to.</param>
    /// <param name="ReportedByFrom">                     The reported by from.</param>
    /// <param name="ReportedByTo">                       The reported by to.</param>
    ///
                            ...
                            else
                            {
                                if((collection["ApplicationFeedbackResourceID"].ToString() == "true,false"))
                                {
                                    try
                                    {
                                        ...
                                        try
                                        {
                                            objFeedbackResource.FirstName =(columnValue);
                                        }
                                        catch
                                        {
                                            objFeedbackResource.FirstName = default(string);
                                        }
    ...
    public void AfterSave(ApplicationFeedback applicationfeedback, GeneratorBase.MVC.Models.IUser aftersaveuser, EntityState entityState)
    {
