...
{
/// <summary>A controller for Verbs Name.</summary>
///
/// <remarks></remarks>
public partial class VerbsNameController : BaseController
{
    ...
    public bool CheckBeforeDelete(VerbsName verbsname)
    {
        var result = true;
    ...
    public string CheckBeforeSave(VerbsName verbsname, string command ="")
    {
        var AlertMsg = "";
        // Write your logic here
    ...
    public void OnDeleting(VerbsName verbsname, ApplicationContext unitdb, GeneratorBase.MVC.Models.IUser ondeletinguser)
    {
        // Write your logic here
    }
    ...
    public void OnSaving(VerbsName verbsname, ApplicationContext db, GeneratorBase.MVC.Models.IUser onsavinguser)
    {
        // Write your logic here
    }
    ...
    public void AfterSave(VerbsName verbsname, GeneratorBase.MVC.Models.IUser aftersaveuser, EntityState entityState)
    {
        // Write your logic here
    }
    ...
    public void AfterDelete(VerbsName verbsname, GeneratorBase.MVC.Models.IUser afterdeleteuser, EntityState entityState)
    {
        // Write your logic here
    }
    ...
    ///
    /// <returns>A string.</returns>
    public string ValidateBeforeDocGenerated(VerbsName verbsname, string documentName, string outputFormat, bool? isdownload)
    {
        var AlertMsg = "";
        // Write your logic here
        //Make sure to assign AlertMsg with proper message
    ...
    /// <param name="outputFormat">The string.</param>
    /// <param name="isdownload">The bool.</param>
    public void OnDocGenerating(GemBox.Document.DocumentModel document, VerbsName verbsname, string documentName, string outputFormat, bool? isdownload)
    {
        // Modify verbsname before generating document
        // e.g. trim some values, add/calculate some in other fields and use in template
        // call execute merge for custom/extra fields
        //e.g.
        //Stream stream = new MemoryStream(db.Documents.FirstOrDefault(p => p.Id == verbsname.T_Picture).Byte);
        //document.MailMerge.Execute(new { ImageField = stream });
        ////To resize and insert use following code
        //var wi = new WebImage(db.Documents.FirstOrDefault(p => p.Id == verbsname.T_Picture).Byte);
    ...
    public void AfterDocGenerated(VerbsName verbsname, string documentName, string outputFormat, bool? isdownload, Stream stream)
    {
        // Write your logic here
...
/// <summary>Custom load view data list after on create.</summary>
    ...
    private void CustomLoadViewDataListAfterOnCreate(VerbsName verbsname)
    {
    }
/// <summary>Custom load view data list before edit.</summary>
    ///
    /// <param name="verbsname">The Verbs Name.</param>
    private void CustomLoadViewDataListBeforeEdit(VerbsName verbsname)
    {
    }
/// <summary>Custom load view data list after edit.</summary>
    ///
    /// <param name="verbsname">The Verbs Name.</param>
    private void CustomLoadViewDataListAfterEdit(VerbsName verbsname)
    {
    }
/// <summary>Custom load view data list on index.</summary>
    ...
    ///
    /// <returns>True if it succeeds, false if it fails.</returns>
    private bool CustomSaveOnCreate(VerbsName verbsname, out bool customcreate_hasissues, string command="")
    {
        var result = false;
...
/// <summary>Custom save on edit.</summary>
    ...
    ///
    /// <returns>True if it succeeds, false if it fails.</returns>
    private bool CustomSaveOnEdit(VerbsName verbsname, out bool customsave_hasissues, string command="")
    {
        var result = false;
...
/// <summary>Custom save on import.</summary>
    ...
    ///
    /// <returns>True if it succeeds, false if it fails.</returns>
    private bool CustomSaveOnImport(VerbsName verbsname, out string customerror, int i)
    {
        var result = false;
        customerror = "";
        return result;
...
/// <summary>Custom import data validate.</summary>
    ...
    ///
    /// <returns>True if it succeeds, false if it fails.</returns>
    private bool CustomDelete(VerbsName verbsname, out bool customdelete_hasissues, string command="")
    {
        var result = false;
    ...
    ///
    /// <param name="list">          The IQueryable<VerbsName> list.</param>
    /// <param name="HostingEntity"> The hosting entity.</param>
    /// <param name="AssociatedType">Type of the associated.</param>
    /// <param name="sortBy">        Describes who sort this object.</param>
    /// <param name="isAsc">         The is ascending.</param>
    ///
    /// <returns>An IQueryable<VerbsName></returns>
    private IQueryable<VerbsName> CustomSorting(IQueryable<VerbsName> list, string HostingEntity, string AssociatedType, string sortBy, string isAsc, string CustomParameter = null, VerbsNameIndexViewModel model = null)
    {
        IQueryable<VerbsName> orderedList = list;
...
/// <summary>Creates a result that redirects to the given route.</summary>
    ...
    private RedirectToRouteResult CustomRedirectUrl(VerbsName verbsname,string action,string command="", string viewmode="")
    {
        // Sample Custom implemention below
        // return RedirectToAction("Index", "VerbsName");
        return null;
    }
    
    private IQueryable<VerbsName> CustomDropdownFilter(IQueryable<VerbsName> list, string caller, string key, string AssoNameWithParent, string AssociationID, string ExtraVal, string RestrictDropdownVal, string CustomParameter, string CallFrom = null)
    {
        return list;
    }
}
