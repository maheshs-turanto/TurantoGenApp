...
{
    /// <summary>Gets import configuration list.</summary>
    ///
    /// <param name="importconfiguration">The importconfiguration.</param>
    ///
    /// <returns>The import configuration list.</returns>
    ...
    /// <summary>Gets import configuration item.</summary>
    ///
    /// <param name="importconfiguration">The importconfiguration.</param>
    ///
    /// <returns>The import configuration item.</returns>
    ...
    ///
    /// <param name="lstImportConfiguration">The list import configuration.</param>
    ...
    /// <summary>GET: /ImportConfiguration/FSearch/.</summary>
    ///
    ...
    /// <param name="LastUpdateFrom">The last update from.</param>
    /// <param name="LastUpdateTo">  The last update to.</param>
    ///
