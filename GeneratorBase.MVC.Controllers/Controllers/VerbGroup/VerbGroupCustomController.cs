...
{
/// <summary>A controller for Verb Group.</summary>
///
/// <remarks></remarks>
public partial class VerbGroupController : BaseController
{
    ...
    public bool CheckBeforeDelete(VerbGroup verbgroup)
    {
        var result = true;
    ...
    public string CheckBeforeSave(VerbGroup verbgroup, string command ="")
    {
        var AlertMsg = "";
        // Write your logic here
    ...
    public void OnDeleting(VerbGroup verbgroup, ApplicationContext unitdb, GeneratorBase.MVC.Models.IUser ondeletinguser)
    {
        // Write your logic here
    }
    ...
    public void OnSaving(VerbGroup verbgroup, ApplicationContext db, GeneratorBase.MVC.Models.IUser onsavinguser)
    {
        // Write your logic here
    }
    ...
    public void AfterSave(VerbGroup verbgroup, GeneratorBase.MVC.Models.IUser aftersaveuser, EntityState entityState)
    {
        // Write your logic here
    }
    ...
    public void AfterDelete(VerbGroup verbgroup, GeneratorBase.MVC.Models.IUser afterdeleteuser, EntityState entityState)
    {
        // Write your logic here
    }
    ...
    ///
    /// <returns>A string.</returns>
    public string ValidateBeforeDocGenerated(VerbGroup verbgroup, string documentName, string outputFormat, bool? isdownload)
    {
        var AlertMsg = "";
        // Write your logic here
        //Make sure to assign AlertMsg with proper message
    ...
    /// <param name="outputFormat">The string.</param>
    /// <param name="isdownload">The bool.</param>
    public void OnDocGenerating(GemBox.Document.DocumentModel document, VerbGroup verbgroup, string documentName, string outputFormat, bool? isdownload)
    {
        // Modify verbgroup before generating document
        // e.g. trim some values, add/calculate some in other fields and use in template
        // call execute merge for custom/extra fields
        //e.g.
        //Stream stream = new MemoryStream(db.Documents.FirstOrDefault(p => p.Id == verbgroup.T_Picture).Byte);
        //document.MailMerge.Execute(new { ImageField = stream });
        ////To resize and insert use following code
        //var wi = new WebImage(db.Documents.FirstOrDefault(p => p.Id == verbgroup.T_Picture).Byte);
    ...
    public void AfterDocGenerated(VerbGroup verbgroup, string documentName, string outputFormat, bool? isdownload, Stream stream)
    {
        // Write your logic here
...
/// <summary>Custom load view data list after on create.</summary>
    ...
    private void CustomLoadViewDataListAfterOnCreate(VerbGroup verbgroup)
    {
    }
/// <summary>Custom load view data list before edit.</summary>
    ///
    /// <param name="verbgroup">The Verb Group.</param>
    private void CustomLoadViewDataListBeforeEdit(VerbGroup verbgroup)
    {
    }
/// <summary>Custom load view data list after edit.</summary>
    ///
    /// <param name="verbgroup">The Verb Group.</param>
    private void CustomLoadViewDataListAfterEdit(VerbGroup verbgroup)
    {
    }
/// <summary>Custom load view data list on index.</summary>
    ...
    ///
    /// <returns>True if it succeeds, false if it fails.</returns>
    private bool CustomSaveOnCreate(VerbGroup verbgroup, out bool customcreate_hasissues, string command="")
    {
        var result = false;
...
/// <summary>Custom save on edit.</summary>
    ...
    ///
    /// <returns>True if it succeeds, false if it fails.</returns>
    private bool CustomSaveOnEdit(VerbGroup verbgroup, out bool customsave_hasissues, string command="")
    {
        var result = false;
...
/// <summary>Custom save on import.</summary>
    ...
    ///
    /// <returns>True if it succeeds, false if it fails.</returns>
    private bool CustomSaveOnImport(VerbGroup verbgroup, out string customerror, int i)
    {
        var result = false;
        customerror = "";
        return result;
...
/// <summary>Custom import data validate.</summary>
    ...
    ///
    /// <returns>True if it succeeds, false if it fails.</returns>
    private bool CustomDelete(VerbGroup verbgroup, out bool customdelete_hasissues, string command="")
    {
        var result = false;
    ...
    ///
    /// <param name="list">          The IQueryable<VerbGroup> list.</param>
    /// <param name="HostingEntity"> The hosting entity.</param>
    /// <param name="AssociatedType">Type of the associated.</param>
    /// <param name="sortBy">        Describes who sort this object.</param>
    /// <param name="isAsc">         The is ascending.</param>
    ///
    /// <returns>An IQueryable<VerbGroup></returns>
    private IQueryable<VerbGroup> CustomSorting(IQueryable<VerbGroup> list, string HostingEntity, string AssociatedType, string sortBy, string isAsc, string CustomParameter = null, VerbGroupIndexViewModel model = null)
    {
        IQueryable<VerbGroup> orderedList = list;
...
/// <summary>Creates a result that redirects to the given route.</summary>
    ...
    private RedirectToRouteResult CustomRedirectUrl(VerbGroup verbgroup,string action,string command="", string viewmode="")
    {
        // Sample Custom implemention below
        // return RedirectToAction("Index", "VerbGroup");
        return null;
    }
    
    private IQueryable<VerbGroup> CustomDropdownFilter(IQueryable<VerbGroup> list, string caller, string key, string AssoNameWithParent, string AssociationID, string ExtraVal, string RestrictDropdownVal, string CustomParameter, string CallFrom = null)
    {
        return list;
    }
}
