...
{
/// <summary>A controller for Document.</summary>
///
/// <remarks></remarks>
public partial class FileDocumentController : BaseController
{
    ...
    public void OnDeleting(FileDocument filedocument, ApplicationContext unitdb, GeneratorBase.MVC.Models.IUser ondeletinguser)
    {
        // Write your logic here
    }
    ...
    public void OnSaving(FileDocument filedocument, ApplicationContext db, GeneratorBase.MVC.Models.IUser onsavinguser)
    {
        // Write your logic here
    }
    ...
    public void AfterSave(FileDocument filedocument, GeneratorBase.MVC.Models.IUser aftersaveuser, EntityState entityState)
    {
        // Write your logic here
    }
    ...
    public void AfterDelete(FileDocument filedocument, GeneratorBase.MVC.Models.IUser afterdeleteuser, EntityState entityState)
    {
        // Write your logic here
    }
    ...
    ///
    /// <returns>A string.</returns>
    public string ValidateBeforeDocGenerated(FileDocument filedocument, string documentName, string outputFormat, bool? isdownload)
    {
        var AlertMsg = "";
        // Write your logic here
        //Make sure to assign AlertMsg with proper message
    ...
    /// <param name="outputFormat">The string.</param>
    /// <param name="isdownload">The bool.</param>
    public void OnDocGenerating(GemBox.Document.DocumentModel document, FileDocument filedocument, string documentName, string outputFormat, bool? isdownload)
    {
        // Modify filedocument before generating document
        // e.g. trim some values, add/calculate some in other fields and use in template
        // call execute merge for custom/extra fields
        //e.g.
        //Stream stream = new MemoryStream(db.Documents.FirstOrDefault(p => p.Id == filedocument.T_Picture).Byte);
        //document.MailMerge.Execute(new { ImageField = stream });
        ////To resize and insert use following code
        //var wi = new WebImage(db.Documents.FirstOrDefault(p => p.Id == filedocument.T_Picture).Byte);
    ...
    public void AfterDocGenerated(FileDocument filedocument, string documentName, string outputFormat, bool? isdownload, Stream stream)
    {
        // Write your logic here
...
/// <summary>Custom import data validate.</summary>
    ...
    ///
    /// <param name="list">          The IQueryable<FileDocument> list.</param>
    /// <param name="HostingEntity"> The hosting entity.</param>
    /// <param name="AssociatedType">Type of the associated.</param>
    /// <param name="sortBy">        Describes who sort this object.</param>
    /// <param name="isAsc">         The is ascending.</param>
    ///
    /// <returns>An IQueryable<FileDocument></returns>
    private IQueryable<FileDocument> CustomSorting(IQueryable<FileDocument> list, string HostingEntity, string AssociatedType, string sortBy, string isAsc, string CustomParameter = null, FileDocumentIndexViewModel model = null)
    {
...
/// <summary>Creates a result that redirects to the given route.</summary>
    ...
    private RedirectToRouteResult CustomRedirectUrl(FileDocument filedocument,string action,string command="", string viewmode="")
    {
    ...
    private IQueryable<FileDocument> CustomDropdownFilter(IQueryable<FileDocument> list, string caller, string key, string AssoNameWithParent, string AssociationID, string ExtraVal, string RestrictDropdownVal, string CustomParameter, string CallFrom = null)
    {
        return list;
    }
}
