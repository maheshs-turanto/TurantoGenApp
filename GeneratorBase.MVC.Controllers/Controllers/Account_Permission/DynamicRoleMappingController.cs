// file:	Controllers\Account_Permission\DynamicRoleMappingController.cs
//
// summary:	Implements the dynamic role mapping controller class
...
public partial class DynamicRoleMappingController : BaseController
{
    ...
    ///
    /// <param name="lstDynamicRoleMapping">The list dynamic role mapping.</param>
    ...
    /// <summary>GET: /DynamicRoleMapping/FSearch/.</summary>
    ///
    ...
    ///
    /// </summary>
    /// <param name="DynamicRoleMapping"></param>
    /// <param name="aftersaveuser"></param>
    ///
    
    public void AfterSave(DynamicRoleMapping dynamicrolemapping, GeneratorBase.MVC.Models.IUser aftersaveuser, EntityState entityState)
    {
