...
{
/// <summary>A controller for handling recurring schedule detailstypes.</summary>
public partial class T_RecurringScheduleDetailstypeController : BaseController
{
    /// <summary>GET: /T_RecurringScheduleDetailstype/.</summary>
    ///
    ...
    public ActionResult Index(string currentFilter, string searchString, string sortBy, string isAsc, int? page, int? itemsPerPage, string HostingEntity, int? HostingEntityID, string AssociatedType, bool? IsExport, bool? IsDeepSearch, bool? IsFilter, bool? RenderPartial, string BulkOperation,string parent,string Wfsearch,string caller, bool? BulkAssociate, string viewtype)
    {
        ...
        {
            if(Request.Cookies["pageSize" + HttpUtility.UrlEncode(User.Name) + "T_RecurringScheduleDetailstype"].Value != "null")
        ...
        {
            if(Request.Cookies["pagination" + HttpUtility.UrlEncode(User.Name) + "T_RecurringScheduleDetailstype"].Value != "null")
    ...
    /// <summary>GET: /T_RecurringScheduleDetailstype/Details/5.</summary>
    ///
    ...
    /// <summary>GET: /T_RecurringScheduleDetailstype/Create.</summary>
    ///
    ...
    /// <summary>GET: /T_RecurringScheduleDetailstype/CreateWizard.</summary>
    ///
    /// <param name="UrlReferrer">      The URL referrer.</param>
    /// <param name="HostingEntityName">Name of the hosting entity.</param>
    /// <param name="HostingEntityID">  Identifier for the hosting entity.</param>
    ...
    /// <summary>POST: /T_RecurringScheduleDetailstype/CreateWizard To protect from overposting
    /// attacks, please enable the specific properties you want to bind to, for more details see
    /// http://go.microsoft.com/fwlink/?LinkId=317598.</summary>
    ///
    /// <param name="t_recurringscheduledetailstype">The recurringscheduledetailstype.</param>
    /// <param name="UrlReferrer">                   The URL referrer.</param>
    ///
    /// <returns>A response stream to send to the CreateWizard View.</returns>
    ...
    /// <summary>GET: /T_RecurringScheduleDetailstype/CreateQuick.</summary>
    ///
    /// <param name="UrlReferrer">      The URL referrer.</param>
    /// <param name="HostingEntityName">Name of the hosting entity.</param>
    /// <param name="HostingEntityID">  Identifier for the hosting entity.</param>
    ...
    /// <summary>POST: /T_RecurringScheduleDetailstype/CreateQuick To protect from overposting attacks,
    ...
    /// <summary>POST: /T_RecurringScheduleDetailstype/Create To protect from overposting attacks,
    /// please enable the specific properties you want to bind to, for more details see
    /// http://go.microsoft.com/fwlink/?LinkId=317598.</summary>
    ///
    /// <param name="t_recurringscheduledetailstype">The recurringscheduledetailstype.</param>
    ...
    /// <summary>GET: /T_RecurringScheduleDetailstype/Edit/5.</summary>
    ///
    /// <param name="id">               The Identifier to delete.</param>
    /// <param name="UrlReferrer">      The URL referrer.</param>
    /// <param name="HostingEntityName">Name of the hosting entity.</param>
    ...
    /// <summary>POST: /T_RecurringScheduleDetailstype/Edit/5 To protect from overposting attacks,
    /// please enable the specific properties you want to bind to, for more details see
    /// http://go.microsoft.com/fwlink/?LinkId=317598.</summary>
    ///
    /// <param name="t_recurringscheduledetailstype">The recurringscheduledetailstype.</param>
    ...
    /// <summary>GET: /T_RecurringScheduleDetailstype/EditWizard/5.</summary>
    ///
    /// <param name="id">         The Identifier to delete.</param>
    /// <param name="UrlReferrer">The URL referrer.</param>
    ///
    ...
    /// <summary>POST: /T_RecurringScheduleDetailstype/EditWizard/5 To protect from overposting
    /// attacks, please enable the specific properties you want to bind to, for more details see
    /// http://go.microsoft.com/fwlink/?LinkId=317598.</summary>
    ///
    /// <param name="t_recurringscheduledetailstype">The recurringscheduledetailstype.</param>
    ...
    /// <summary>GET: /T_RecurringScheduleDetailstype/Delete/5.</summary>
    ///
    ...
    /// <summary>POST: /T_RecurringScheduleDetailstype/Delete/5.</summary>
    ///
    /// <param name="t_recurringscheduledetailstype">The recurringscheduledetailstype.</param>
    /// <param name="UrlReferrer">                   The URL referrer.</param>
    ///
