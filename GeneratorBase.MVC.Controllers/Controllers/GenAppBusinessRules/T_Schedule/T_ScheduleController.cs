...
public partial class T_ScheduleController : BaseController
{
    ...
    ///
    /// <param name="lstT_Schedule">The list schedule.</param>
    ...
    /// <param name="t_associatedscheduletype">                The associatedscheduletype.</param>
    /// <param name="t_associatedrecurringscheduledetailstype"> The
    ///                                                         associatedrecurringscheduledetailstype.</param>
    /// <param name="t_recurringrepeatfrequency">              The recurringrepeatfrequency.</param>
    /// <param name="t_repeatby">                              The repeatby.</param>
    /// <param name="t_recurringtaskendtype">                  The recurringtaskendtype.</param>
    ///
    ...
    /// <summary>GET: /T_Schedule/FSearch/.</summary>
    ///
    ...
    /// <param name="t_repeatby">                              The repeatby.</param>
    /// <param name="t_recurringtaskendtype">                  The recurringtaskendtype.</param>
    /// <param name="T_StartDateTimeFrom">                     The start date time from.</param>
    /// <param name="T_StartDateTimeTo">                       The start date time to.</param>
    /// <param name="T_EndDateFrom">                           The end date from.</param>
    /// <param name="T_EndDateTo">                             The end date to.</param>
    /// <param name="T_OccurrenceLimitCountFrom">               The occurrence limit count from.</param>
    /// <param name="T_OccurrenceLimitCountTo">                The occurrence limit count to.</param>
    /// <param name="HostingEntity">                           The hosting entity.</param>
    /// <param name="AssociatedType">                          Type of the associated.</param>
    /// <param name="HostingEntityID">                          Identifier for the hosting entity.</param>
    ...
    public void OnSaving(T_Schedule t_schedule, ApplicationContext db, GeneratorBase.MVC.Models.IUser onsavinguser)
    {
        // Write your logic here
