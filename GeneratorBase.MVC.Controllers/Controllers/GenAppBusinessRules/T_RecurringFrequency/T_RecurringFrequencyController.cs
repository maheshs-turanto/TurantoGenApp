...
public partial class T_RecurringFrequencyController : BaseController
{
    ...
    ///
    /// <param name="lstT_RecurringFrequency">The list recurring frequency.</param>
    ...
    /// <summary>GET: /T_RecurringFrequency/FSearch/.</summary>
    ///
    ...
    /// <param name="T_NameFrom">     The name from.</param>
    /// <param name="T_NameTo">       The name to.</param>
    /// <param name="HostingEntity">  The hosting entity.</param>
    /// <param name="AssociatedType"> Type of the associated.</param>
    /// <param name="HostingEntityID">Identifier for the hosting entity.</param>
    ...
    public void OnSaving(T_RecurringFrequency t_recurringfrequency, ApplicationContext db, GeneratorBase.MVC.Models.IUser onsavinguser)
    {
        // Write your logic here
    }
    ...
    public void AfterSave(T_RecurringFrequency t_recurringfrequency, GeneratorBase.MVC.Models.IUser aftersaveuser, EntityState entityState)
    {
        // Write your logic here
    }
