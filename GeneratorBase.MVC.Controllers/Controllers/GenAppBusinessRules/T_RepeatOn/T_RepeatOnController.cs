...
public partial class T_RepeatOnController : BaseController
{
    ...
    ///
    /// <param name="lstT_RepeatOn">The list repeat on.</param>
    ...
    /// <summary>GET: /T_RepeatOn/FSearch/.</summary>
    ///
                            ...
                            else
                            {
                                if((collection["T_ScheduleID"].ToString() == "true,false"))
                                {
                                    try
                                    {
                                        ...
                                        try
                                        {
                                            objT_Schedule.T_StartDateTime =Convert.ToDateTime(columnValue);
                                        }
                                        catch
                                        {
                                            objT_Schedule.T_StartDateTime = DateTime.MaxValue;
                                        }
    ...
    public void OnSaving(T_RepeatOn t_repeaton, ApplicationContext db, GeneratorBase.MVC.Models.IUser onsavinguser)
    {
        // Write your logic here
    }
    ...
    public void AfterSave(T_RepeatOn t_repeaton, GeneratorBase.MVC.Models.IUser aftersaveuser, EntityState entityState)
    {
        // Write your logic here
    }
