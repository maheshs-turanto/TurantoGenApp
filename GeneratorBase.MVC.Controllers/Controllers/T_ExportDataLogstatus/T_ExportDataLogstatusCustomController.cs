...
{
/// <summary>A controller for ExportDataLog Status.</summary>
///
/// <remarks></remarks>
public partial class T_ExportDataLogstatusController : BaseController
{
    ...
    public bool CheckBeforeDelete(T_ExportDataLogstatus t_exportdatalogstatus)
    {
        var result = true;
    ...
    public string CheckBeforeSave(T_ExportDataLogstatus t_exportdatalogstatus, string command ="")
    {
        var AlertMsg = "";
        // Write your logic here
    ...
    public void OnDeleting(T_ExportDataLogstatus t_exportdatalogstatus, ApplicationContext unitdb, GeneratorBase.MVC.Models.IUser ondeletinguser)
    {
        // Write your logic here
    }
    ...
    public void OnSaving(T_ExportDataLogstatus t_exportdatalogstatus, ApplicationContext db, GeneratorBase.MVC.Models.IUser onsavinguser)
    {
        // Write your logic here
    }
    ...
    public void AfterSave(T_ExportDataLogstatus t_exportdatalogstatus, GeneratorBase.MVC.Models.IUser aftersaveuser, EntityState entityState)
    {
        // Write your logic here
    }
    ...
    ///
    /// <returns>A string.</returns>
    public string ValidateBeforeDocGenerated(T_ExportDataLogstatus t_exportdatalogstatus, string documentName, string outputFormat, bool? isdownload)
    {
        var AlertMsg = "";
        // Write your logic here
        //Make sure to assign AlertMsg with proper message
    ...
    /// <param name="outputFormat">The string.</param>
    /// <param name="isdownload">The bool.</param>
    public void OnDocGenerating(GemBox.Document.DocumentModel document, T_ExportDataLogstatus t_exportdatalogstatus, string documentName, string outputFormat, bool? isdownload)
    {
        // Modify t_exportdatalogstatus before generating document
        // e.g. trim some values, add/calculate some in other fields and use in template
        // call execute merge for custom/extra fields
        //e.g.
        //Stream stream = new MemoryStream(db.Documents.FirstOrDefault(p => p.Id == t_exportdatalogstatus.T_Picture).Byte);
        //document.MailMerge.Execute(new { ImageField = stream });
        ////To resize and insert use following code
        //var wi = new WebImage(db.Documents.FirstOrDefault(p => p.Id == t_exportdatalogstatus.T_Picture).Byte);
    ...
    public void AfterDocGenerated(T_ExportDataLogstatus t_exportdatalogstatus, string documentName, string outputFormat, bool? isdownload, Stream stream)
    {
        // Write your logic here
...
/// <summary>Custom load view data list after on create.</summary>
    ...
    private void CustomLoadViewDataListAfterOnCreate(T_ExportDataLogstatus t_exportdatalogstatus)
    {
    }
/// <summary>Custom load view data list before edit.</summary>
    ///
    /// <param name="t_exportdatalogstatus">The ExportDataLog Status.</param>
    private void CustomLoadViewDataListBeforeEdit(T_ExportDataLogstatus t_exportdatalogstatus)
    {
    }
/// <summary>Custom load view data list after edit.</summary>
    ///
    /// <param name="t_exportdatalogstatus">The ExportDataLog Status.</param>
    private void CustomLoadViewDataListAfterEdit(T_ExportDataLogstatus t_exportdatalogstatus)
    {
    }
/// <summary>Custom load view data list on index.</summary>
    ...
    ///
    /// <returns>True if it succeeds, false if it fails.</returns>
    private bool CustomSaveOnCreate(T_ExportDataLogstatus t_exportdatalogstatus, out bool customcreate_hasissues, string command="")
    {
        var result = false;
...
/// <summary>Custom save on edit.</summary>
    ...
    ///
    /// <returns>True if it succeeds, false if it fails.</returns>
    private bool CustomSaveOnEdit(T_ExportDataLogstatus t_exportdatalogstatus, out bool customsave_hasissues, string command="")
    {
        var result = false;
...
/// <summary>Custom save on import.</summary>
    ...
    ///
    /// <returns>True if it succeeds, false if it fails.</returns>
    private bool CustomSaveOnImport(T_ExportDataLogstatus t_exportdatalogstatus, out string customerror, int i)
    {
        var result = false;
        customerror = "";
        return result;
...
/// <summary>Custom import data validate.</summary>
    ...
    ///
    /// <returns>True if it succeeds, false if it fails.</returns>
    private bool CustomDelete(T_ExportDataLogstatus t_exportdatalogstatus, out bool customdelete_hasissues, string command="")
    {
        var result = false;
    ...
    ///
    /// <param name="list">          The IQueryable<T_ExportDataLogstatus> list.</param>
    /// <param name="HostingEntity"> The hosting entity.</param>
    /// <param name="AssociatedType">Type of the associated.</param>
    /// <param name="sortBy">        Describes who sort this object.</param>
    /// <param name="isAsc">         The is ascending.</param>
    ///
    /// <returns>An IQueryable<T_ExportDataLogstatus></returns>
    private IQueryable<T_ExportDataLogstatus> CustomSorting(IQueryable<T_ExportDataLogstatus> list, string HostingEntity, string AssociatedType, string sortBy, string isAsc, string CustomParameter = null)
    {
        IQueryable<T_ExportDataLogstatus> orderedList = list;
...
/// <summary>Creates a result that redirects to the given route.</summary>
    ...
    private RedirectToRouteResult CustomRedirectUrl(T_ExportDataLogstatus t_exportdatalogstatus,string action,string command="", string viewmode="")
    {
        // Sample Custom implemention below
        // return RedirectToAction("Index", "T_ExportDataLogstatus");
        return null;
    }
    
    private IQueryable<T_ExportDataLogstatus> CustomDropdownFilter(IQueryable<T_ExportDataLogstatus> list, string caller, string key, string AssoNameWithParent, string AssociationID, string ExtraVal, string RestrictDropdownVal, string CustomParameter, string CallFrom = null)
    {
        return list;
    }
}
