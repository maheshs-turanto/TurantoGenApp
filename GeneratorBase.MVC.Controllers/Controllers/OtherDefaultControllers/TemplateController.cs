...
{
/// <summary>A controller for handling templates.</summary>
public class TemplateController : Controller
{
    ...
    /// <summary>Generates a document.</summary>
    ///
    /// <param name="id">The identifier.</param>
    ///
    /// <returns>A response stream to send to the GenerateDocument View.</returns>
        ...
        try
        {
            ...
            using(FileStream fileStream = System.IO.File.OpenRead(filePath))
            {
                ...
                var cd = new System.Net.Mime.ContentDisposition
                {
                    ...
                    FileName = id == 6 ? documentName(id) : appName + " - " + documentName(id).Replace(".docx", "") + " - v1.docx",
                    Inline = false,
                };
    ...
    ///
    /// <param name="generateDocument">The generate document.</param>
    /// <param name="appName">         Name of the application.</param>
    /// <param name="dateCreate">      The date create.</param>
    /// <param name="timeCreate">      The time create.</param>
    ///
    /// <returns>A DocX.</returns>
    ...
    /// <summary>Rule evaluate.</summary>
    ///
    /// <param name="objBR">The object line break.</param>
    ///
    /// <returns>A string.</returns>
    ...
    /// <summary>Rule action dp.</summary>
    ///
    /// <param name="objRA">     The object ra.</param>
    ...
    private string RuleActionDP(RuleAction objRA, string entityName)
    {
        ...
        case 3:
        {
            ...
            {
                var dbrole = (new ApplicationDbContext(true)).Roles;
    ...
    /// <summary>Gets substring by string.</summary>
    ///
    /// <param name="a">A string to process.</param>
    /// <param name="b">A string to process.</param>
    /// <param name="c">A string to process.</param>
    ///
    /// <returns>The substring by string.</returns>
    ...
    /// <summary>Argument action list.</summary>
    ///
    /// <param name="argacn">    The argacn.</param>
    /// <param name="entityName">Name of the entity.</param>
    ///
    ...
    /// <summary>Cast that converts the given string to a Dp.</summary>
    ///
    ...
    public static string propDP(string entityName, string propName)
    {
        ...
        try
        {
            var entityModel = ModelReflector.Entities.FirstOrDefault(e => e.Name == entityName);
            var entityInfo = entityModel.Properties.Where(p => p.Name == propName);
            if(entityInfo == null)
                propDP = entityModel.Associations.FirstOrDefault(p => p.AssociationProperty == propName).DisplayName;
            else
                propDP = entityModel.Properties.FirstOrDefault(p => p.Name == propName).DisplayName;
        }
        catch
        {
            return propName;
    ...
    /// <summary>Role and permission.</summary>
    ///
    /// <param name="generateDocument">The generate document.</param>
    /// <param name="tblCnt">          Number of tables.</param>
    ///
    /// <returns>A DocX.</returns>
    ...
    /// <summary>Role and permission new.</summary>
    ///
    /// <param name="generateDocument">The generate document.</param>
    /// <param name="tblCnt">          Number of tables.</param>
    ///
    ...
    /// <summary>Entity based security.</summary>
    ///
    /// <param name="generateDocument">The generate document.</param>
    /// <param name="tblCnt">          Number of tables.</param>
    ///
    ...
    private DocX EntityBasedSecurity(DocX generateDocument, int tblCnt)
    {
        ...
        if(rolePermission.Count() > 0)
        {
            ...
            foreach(var paragraph in generateDocument.Paragraphs.Where(p => p.Text.Contains("#Table_EntityBasedSecurity#")))
            {
                ...
                {
                    tblCnt++;
                    strCaption = "Table " + tblCnt.ToString() + ": EntityDefault Based Security View for Functional Entities ";
                ...
                {
                    tblCnt++;
                    strCaption = "Table " + tblCnt.ToString() + ": EntityDefault Based Security View for Entities Built in Turanto ";
                    paragraph.FindAll("#Table_EntityBasedSecurity#").ForEach(index => paragraph.InsertParagraphBeforeSelf(Caption(strCaption, "", generateDocument)));
    ...
    /// <summary>Dynamic mapping.</summary>
    ///
    /// <param name="generateDocument">The generate document.</param>
    /// <param name="tblCnt">          Number of tables.</param>
    ///
    ...
    private DocX DynamicMapping(DocX generateDocument, int tblCnt)
    {
        ...
        var drmFList = Db.DynamicRoleMappings.Where(d => d.Condition != "NA").ToList();
    ...
    /// <summary>Entity property.</summary>
    ///
    /// <param name="propEditList">List of property edits.</param>
    /// <param name="propViewList">List of property views.</param>
    ///
    /// <returns>A List&lt;string&gt;</returns>
    ...
    /// <summary>Role information.</summary>
    ///
    /// <param name="RoleName">Name of the role.</param>
    /// <param name="UserCnt"> Number of users.</param>
    ///
    /// <returns>A List&lt;RoleInfo&gt;</returns>
    ...
    /// <summary>Table with data.</summary>
    ///
    /// <param name="listData">Information describing the list.</param>
    /// <param name="document">The document.</param>
    /// <param name="IsHeader">(Optional) True if is header, false if not.</param>
    ///
    ...
    ///
    /// <param name="listData"> Information describing the list.</param>
    /// <param name="colString">The col string.</param>
    /// <param name="document"> The document.</param>
    /// <param name="IsHeader"> (Optional) True if is header, false if not.</param>
    ///
    /// <returns>A Table.</returns>
    ...
    ///
    /// <param name="strText"> The text.</param>
    /// <param name="strGray"> The gray.</param>
    /// <param name="document">The document.</param>
    ///
    /// <returns>A Paragraph.</returns>
    ...
    /// <summary>Header image place.</summary>
    ///
    /// <param name="document">   The document.</param>
    /// <param name="companyLogo">The company logo.</param>
    /// <param name="value">      The value.</param>
    ...
    /// <summary>Reads image file.</summary>
    ///
    ...
    /// <param name="preserveAspectRatio">(Optional) True to preserve aspect ratio.</param>
    ///
    ...
    /// <summary>Permission by role.</summary>
    ///
...
class FLS
{
    ...
    /// <summary>Gets or sets the cannot edit.</summary>
    ///
    /// <value>The cannot edit.</value>
    
    public string Cannot_Edit
    {
        get;
        set;
    }
    
    /// <summary>Gets or sets the cannot view.</summary>
    ///
    /// <value>The cannot view.</value>
    
    public string Cannot_View
    {
        get;
        set;
    }
}
/// <summary>Information about the role.</summary>
class RoleInfo
{
