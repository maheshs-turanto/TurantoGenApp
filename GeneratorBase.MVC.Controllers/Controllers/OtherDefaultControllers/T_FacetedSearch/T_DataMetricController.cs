...
{
/// <summary>A partial controller class for Data Metric actions (helper methods and other actions).</summary>
///
/// <remarks></remarks>
public partial class T_DataMetricController : BaseController
{
    ...
    private void LoadViewDataForCount(T_DataMetric t_datametric, string AssocType)
    {
    }
    /// <summary>Loads view data after on edit.</summary>
    ///
    /// <param name="t_datametric">The Data Metric.</param>
    private void LoadViewDataAfterOnEdit(T_DataMetric t_datametric)
    {
        LoadViewDataBeforeOnEdit(t_datametric, false);
        CustomLoadViewDataListAfterEdit(t_datametric);
    }
    /// <summary>Loads view data before on edit.</summary>
    ///
    /// <param name="t_datametric">         The Data Metric.</param>
    /// <param name="loadCustomViewData">(Optional) True to load custom view data.</param>
    private void LoadViewDataBeforeOnEdit(T_DataMetric t_datametric, bool loadCustomViewData = true)
    {
        FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
        var _objT_AssociatedDataMetricType = new List<T_DataMetrictype>();
        _objT_AssociatedDataMetricType.Add(t_datametric.t_associateddatametrictype);
        ViewBag.T_AssociatedDataMetricTypeID = new SelectList(_objT_AssociatedDataMetricType, "ID", "DisplayValue", t_datametric.T_AssociatedDataMetricTypeID);
        var _objT_AssociatedFacetedSearch = new List<T_FacetedSearch>();
        _objT_AssociatedFacetedSearch.Add(t_datametric.t_associatedfacetedsearch);
        ViewBag.T_AssociatedFacetedSearchID = new SelectList(_objT_AssociatedFacetedSearch, "ID", "DisplayValue", t_datametric.T_AssociatedFacetedSearchID);
        ...
        var T_DisplayOnList = new Dictionary<string, string>();
        T_DisplayOnList.Add("Index", "Home Page");
        //T_DisplayOnList.Add("EntityHome", "Entity Home");
        T_DisplayOnList.Add("Home1", "Home1 Page");
        T_DisplayOnList.Add("Home2", "Home2 Page");
        T_DisplayOnList.Add("Home3", "Home3 Page");
        T_DisplayOnList.Add("Dashboard", "Dashboard Page");
        foreach(var item in GeneratorBase.MVC.Models.CommonFunction.Instance.GetEntityHomePages())
        {
            T_DisplayOnList.Add(item.Key, item.Value);
        }
        ViewBag.T_DisplayOnList = new SelectList(T_DisplayOnList, "Key", "Value");
        ViewBag.T_DataMetricIsHiddenRule = checkHidden(User, "T_DataMetric", "OnEdit", false, null);
        ViewBag.T_DataMetricIsGroupsHiddenRule = checkHidden(User, "T_DataMetric", "OnEdit", true, null);
        ViewBag.T_DataMetricIsSetValueUIRule = checkSetValueUIRule(User, "T_DataMetric", "OnEdit", new long[] { 6, 8 }, null, null);
        ViewBag.T_DataMetricRestrictDropdownValueRule = RestrictDropdownValueRule(User, "T_DataMetric", "OnEdit", new long[] { 6, 8 }, null, new string[] { "" });
        if(loadCustomViewData) CustomLoadViewDataListBeforeEdit(t_datametric);
    }
    /// <summary>Loads view data after on create.</summary>
    ///
    /// <param name="t_datametric">The Data Metric.</param>
    private void LoadViewDataAfterOnCreate(T_DataMetric t_datametric)
    {
        ViewBag.T_AssociatedDataMetricTypeID = new SelectList(db.T_DataMetrictypes.Where(p => p.Id == t_datametric.T_AssociatedDataMetricTypeID), "ID", "DisplayValue", t_datametric.T_AssociatedDataMetricTypeID);
        ViewBag.T_AssociatedFacetedSearchID = new SelectList(db.T_FacetedSearchs.Where(p => p.Id == t_datametric.T_AssociatedFacetedSearchID), "ID", "DisplayValue", t_datametric.T_AssociatedFacetedSearchID);
        CustomLoadViewDataListAfterOnCreate(t_datametric);
        ViewBag.T_DataMetricIsHiddenRule = checkHidden(User, "T_DataMetric", "OnCreate", false, null);
        ViewBag.T_DataMetricIsGroupsHiddenRule = checkHidden(User, "T_DataMetric", "OnCreate", true, null);
        ViewBag.T_DataMetricIsSetValueUIRule = checkSetValueUIRule(User, "T_DataMetric", "OnCreate", new long[] { 6, 7 }, null, null);
        ViewBag.T_DataMetricRestrictDropdownValueRule = RestrictDropdownValueRule(User, "T_DataMetric", "OnCreate", new long[] { 6, 7 }, null, new string[] { "" });
    }
    ...
    {
        FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
        if(HostingEntityName == "T_DataMetrictype" && Convert.ToInt64(HostingEntityID) > 0 && AssociatedType == "T_AssociatedDataMetricType")
        {
            var hostid = Convert.ToInt64(HostingEntityID);
            var objList = db.T_DataMetrictypes.Where(p => p.Id == hostid).ToList();
            ViewBag.T_AssociatedDataMetricTypeID = new SelectList(objList, "ID", "DisplayValue", HostingEntityID);
            ViewBag.DisplayVal = objList.FirstOrDefault().DisplayValue;
        }
        else
        {
            var objT_AssociatedDataMetricType = db.T_DataMetrictypes.Where(p => p.Id == 1).ToList();
            ViewBag.T_AssociatedDataMetricTypeID = new SelectList(objT_AssociatedDataMetricType, "ID", "DisplayValue", 1);
            //
        }
        if(HostingEntityName == "T_FacetedSearch" && Convert.ToInt64(HostingEntityID) > 0 && AssociatedType == "T_AssociatedFacetedSearch")
        {
            var hostid = Convert.ToInt64(HostingEntityID);
            var objList = db.T_FacetedSearchs.Where(p => p.Id == hostid).ToList();
            ViewBag.T_AssociatedFacetedSearchID = new SelectList(objList, "ID", "DisplayValue", HostingEntityID);
            ViewBag.DisplayVal = objList.FirstOrDefault().DisplayValue;
        }
        else
        {
            var objT_AssociatedFacetedSearch = new List<T_DataMetrictype>();
            ViewBag.T_AssociatedFacetedSearchID = new SelectList(objT_AssociatedFacetedSearch, "ID", "DisplayValue");
            //
        }
        var RoleList = (new GeneratorBase.MVC.Models.CustomRoleProvider()).GetAllRoles().ToList();
        RoleList.Add("All");
    ...
    public ActionResult ShowMetric(int? id)
    {
        //var list = db.T_DataMetrics.Where(p => p.Id == id && (p.t_associateddatametrictype.T_Name == "Number" || p.t_associateddatametrictype.T_Name == "HyperLink") && !p.T_Hide.Value).OrderBy(p => p.T_DisplayOrder).ToList();
        ...
        var list = db.T_DataMetrics.Where(p => p.Id == id && (p.t_associateddatametrictype.T_Name == "Number") && !p.T_Hide.Value).OrderBy(p => p.T_DisplayOrder).ToList();
        list = list.Where(p => User.CanView(p.T_EntityName) && (string.IsNullOrEmpty(p.T_Roles) || User.IsInRole(User.userroles, p.T_Roles.Split(",".ToCharArray()))) && p.T_AssociatedFacetedSearchID.HasValue).ToList();
        ViewBag.Metrics = list;
        var listmetrics = db.T_DataMetrics.Where(p => p.Id == id && p.t_associateddatametrictype.T_Name == "List" && !p.T_Hide.Value).OrderBy(p => p.T_DisplayOrder).ToList();
        ...
        var listGraph = db.T_DataMetrics.Where(p => p.Id == id && p.t_associateddatametrictype.T_Name == "Graph" && !p.T_Hide.Value).OrderBy(p => p.T_DisplayOrder).ToList();
        ...
        var listHyperlink = db.T_DataMetrics.Where(p => p.t_associateddatametrictype.T_Name == "HyperLink" && !p.T_Hide.Value).OrderBy(p => p.T_DisplayOrder).ToList();
    ...
    public FileResult DownloadExcel(List<GeneratorBase.MVC.Models.T_DataMetric> query)
    {
        foreach(var item in query)
        {
            item.setDateTimeToClientTime();
            item.ApplyHiddenRule(User.businessrules, "T_DataMetric");
        }
        DataTable dt = ExcelExportHelper.ToDataTable<T_DataMetric>(User, query, "T_DataMetric");
        dt.AcceptChanges();
        string fileName = "Data Metric.xlsx";
        using(ClosedXML.Excel.XLWorkbook wb = new ClosedXML.Excel.XLWorkbook())
        {
            var columns = EntityColumns().Select(p => p.Value).ToArray();
            dt.SetColumnsOrder(columns);
            dt.RemoveColumns(new string[] { "Metric Icon" });
            wb.Properties.Author = "DashboardDemoV2";
            wb.Properties.Title = "Data Metric";
            wb.Properties.Subject = "Data Metric data";
    ...
    private Dictionary<string, string> EntityColumns()
    {
        ...
        columns.Add("3", modelproperties.FirstOrDefault(q => q.Name == "T_ToolTip").DisplayName);
        columns.Add("4", modelproperties.FirstOrDefault(q => q.Name == "T_AssociatedDataMetricTypeID").DisplayName);
        columns.Add("5", modelproperties.FirstOrDefault(q => q.Name == "T_AssociatedFacetedSearchID").DisplayName);
        columns.Add("6", modelproperties.FirstOrDefault(q => q.Name == "T_Aggregate").DisplayName);
        columns.Add("7", modelproperties.FirstOrDefault(q => q.Name == "T_EntityName").DisplayName);
        columns.Add("8", modelproperties.FirstOrDefault(q => q.Name == "T_AggregatePropertyName").DisplayName);
        columns.Add("9", modelproperties.FirstOrDefault(q => q.Name == "T_Roles").DisplayName);
        columns.Add("10", modelproperties.FirstOrDefault(q => q.Name == "T_BackGroundColor").DisplayName);
        columns.Add("11", modelproperties.FirstOrDefault(q => q.Name == "T_FontColor").DisplayName);
        columns.Add("12", modelproperties.FirstOrDefault(q => q.Name == "T_Hide").DisplayName);
        columns.Add("13", modelproperties.FirstOrDefault(q => q.Name == "T_ClassIcon").DisplayName);
        columns.Add("14", modelproperties.FirstOrDefault(q => q.Name == "T_DisplayOrder").DisplayName);
        columns.Add("15", modelproperties.FirstOrDefault(q => q.Name == "T_DisplayOn").DisplayName);
        return columns;
    }
    
    /// <summary>Append search conditions in IQueryable.</summary>
    ///
    /// <param name="lstT_DataMetric">The list Data Metric.</param>
    /// <param name="searchString">The search string.</param>
    /// <param name="IsDeepSearch">Is deep search.</param>
    ///
    /// <returns>The found records.</returns>
    private IQueryable<T_DataMetric> searchRecords(IQueryable<T_DataMetric> lstT_DataMetric, string searchString, bool? IsDeepSearch)
    {
        searchString = searchString.Trim();
        if(Convert.ToBoolean(IsDeepSearch))
            lstT_DataMetric = lstT_DataMetric.Where(s => (!String.IsNullOrEmpty(s.T_Name) && s.T_Name.ToUpper().Contains(searchString)) || (!String.IsNullOrEmpty(s.T_ToolTip) && s.T_ToolTip.ToUpper().Contains(searchString)) || (s.t_associateddatametrictype != null && (s.t_associateddatametrictype.DisplayValue.ToUpper().Contains(searchString))) || (!String.IsNullOrEmpty(s.T_Aggregate) && s.T_Aggregate.ToUpper().Contains(searchString)) || (!String.IsNullOrEmpty(s.T_EntityName) && s.T_EntityName.ToUpper().Contains(searchString)) || (!String.IsNullOrEmpty(s.T_AggregatePropertyName) && s.T_AggregatePropertyName.ToUpper().Contains(searchString)) || (!String.IsNullOrEmpty(s.T_Roles) && s.T_Roles.ToUpper().Contains(searchString)) || (!String.IsNullOrEmpty(s.T_BackGroundColor) && s.T_BackGroundColor.ToUpper().Contains(searchString)) || (!String.IsNullOrEmpty(s.T_FontColor) && s.T_FontColor.ToUpper().Contains(searchString)) || (!String.IsNullOrEmpty(s.T_ClassIcon) && s.T_ClassIcon.ToUpper().Contains(searchString)) || (!String.IsNullOrEmpty(s.DisplayValue) && s.DisplayValue.ToUpper().Contains(searchString)));
        else
            lstT_DataMetric = lstT_DataMetric.Where(s => (!String.IsNullOrEmpty(s.T_Name) && s.T_Name.ToUpper().Contains(searchString)) || (!String.IsNullOrEmpty(s.T_ToolTip) && s.T_ToolTip.ToUpper().Contains(searchString)) || (s.t_associateddatametrictype != null && (s.t_associateddatametrictype.DisplayValue.ToUpper().Contains(searchString))) || (!String.IsNullOrEmpty(s.T_Aggregate) && s.T_Aggregate.ToUpper().Contains(searchString)) || (!String.IsNullOrEmpty(s.T_EntityName) && s.T_EntityName.ToUpper().Contains(searchString)) || (!String.IsNullOrEmpty(s.T_AggregatePropertyName) && s.T_AggregatePropertyName.ToUpper().Contains(searchString)) || (!String.IsNullOrEmpty(s.T_Roles) && s.T_Roles.ToUpper().Contains(searchString)) || (!String.IsNullOrEmpty(s.T_BackGroundColor) && s.T_BackGroundColor.ToUpper().Contains(searchString)) || (!String.IsNullOrEmpty(s.T_FontColor) && s.T_FontColor.ToUpper().Contains(searchString)) || (!String.IsNullOrEmpty(s.T_ClassIcon) && s.T_ClassIcon.ToUpper().Contains(searchString)) || (!String.IsNullOrEmpty(s.DisplayValue) && s.DisplayValue.ToUpper().Contains(searchString)));
        bool boolvalue;
        if(Boolean.TryParse(searchString, out boolvalue))
            lstT_DataMetric = lstT_DataMetric.Union(db.T_DataMetrics.Where(s => (s.T_Hide == boolvalue)));
        return lstT_DataMetric;
    }
    /// <summary>Order by list on column.</summary>
    ///
    /// <param name="lstT_DataMetric">The IQueryable list Data Metric.</param>
    /// <param name="sortBy">      Column used to sort list.</param>
    /// <param name="isAsc">       Is ascending.</param>
    ///
    /// <returns>The sorted records.</returns>
    private IQueryable<T_DataMetric> sortRecords(IQueryable<T_DataMetric> lstT_DataMetric, string sortBy, string isAsc)
    {
        string methodName = "";
        ...
        if(sortBy == "T_AssociatedDataMetricTypeID")
            return isAsc.ToLower() == "asc" ? lstT_DataMetric.OrderBy(p => p.t_associateddatametrictype.DisplayValue) : lstT_DataMetric.OrderByDescending(p => p.t_associateddatametrictype.DisplayValue);
        if(sortBy.Contains("."))
            return isAsc.ToLower() == "asc" ? lstT_DataMetric.Sort(sortBy, true) : lstT_DataMetric.Sort(sortBy, false);
        ParameterExpression paramExpression = Expression.Parameter(typeof(T_DataMetric), "t_datametric");
        MemberExpression memExp = Expression.PropertyOrField(paramExpression, sortBy);
        LambdaExpression lambda = Expression.Lambda(memExp, paramExpression);
        return (IQueryable<T_DataMetric>)lstT_DataMetric.Provider.CreateQuery(
                   Expression.Call(
                       typeof(Queryable),
                       methodName,
                       new Type[] { lstT_DataMetric.ElementType, lambda.Body.Type },
                       lstT_DataMetric.Expression,
                       lambda));
    }
    ...
    public ActionResult SetFSearch(string searchString, string HostingEntity, string t_associateddatametrictype, bool? RenderPartial, bool ShowDeleted = false)
    {
        int Qcount = 0;
        ...
        {
            FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
            var T_AssociatedDataMetricTypelist = _fad.FilterDropdown<T_DataMetrictype>(User, db.T_DataMetrictypes, "T_DataMetrictype", null);
            SetFSearchDropdownViewBag(T_AssociatedDataMetricTypelist, t_associateddatametrictype, "T_DataMetrictype", "Data Metric Type", "t_associateddatametrictype");
        }
        else
        {
            var objT_AssociatedDataMetricType = new List<T_DataMetrictype>();
            ViewBag.t_associateddatametrictype = new SelectList(objT_AssociatedDataMetricType, "ID", "DisplayValue");
        }
        SetFSearchViewBag("T_DataMetric");
        ViewBag.HideColumns = new MultiSelectList(EntityColumns(), "Key", "Value");
        return View(new T_DataMetric());
    }
    ...
    [Audit("FacetedSearch")]
    public ActionResult FSearch(string currentFilter, string searchString, string FSFilter, string sortBy, string isAsc, int? page, int? itemsPerPage, string search, bool? IsExport, string t_associateddatametrictype, string T_Hide, string FilterCondition, string HostingEntity, string AssociatedType, string HostingEntityID, string viewtype, string SortOrder, string HideColumns, string GroupByColumn, bool? IsReports, bool? IsdrivedTab, bool? IsFilter = false, bool ShowDeleted = false)
    {
        FSearchViewBag(currentFilter, searchString, FSFilter, sortBy, isAsc, page, itemsPerPage, search, FilterCondition, HostingEntity, AssociatedType, HostingEntityID, viewtype, SortOrder, HideColumns, GroupByColumn, IsReports, IsdrivedTab, IsFilter, "T_DataMetric");
        ...
        {
            lstT_DataMetric = searchRecords(lstT_DataMetric, searchString.ToUpper(), true);
        }
        ...
        if(!string.IsNullOrEmpty(search))
        {
            ...
            lstT_DataMetric = searchRecords(lstT_DataMetric, search, true);
        }
        if(!String.IsNullOrEmpty(sortBy) && !String.IsNullOrEmpty(isAsc))
        {
            lstT_DataMetric = sortRecords(lstT_DataMetric, sortBy, isAsc);
        }
        else lstT_DataMetric = lstT_DataMetric.OrderByDescending(c => c.Id);
        lstT_DataMetric = CustomSorting(lstT_DataMetric, HostingEntity, AssociatedType, sortBy, isAsc);
        //lstT_DataMetric = lstT_DataMetric.IncludeOptimized(t=>t.t_associateddatametrictype);
        if(!string.IsNullOrEmpty(FilterCondition))
        {
            ...
            foreach(var cond in conditions)
            {
                ...
                if(iCnt == conditions.Count())
                    LogicalConnector = "";
                ViewBag.SearchResult += " " + GetPropertyDP("T_DataMetric", PropertyName) + " " + Operator + " " + Value + " " + LogicalConnector;
                whereCondition.Append(conditionFSearch("T_DataMetric", PropertyName, Operator, Value) + LogicalConnector);
                iCnt++;
            }
            if(!string.IsNullOrEmpty(whereCondition.ToString()))
                lstT_DataMetric = lstT_DataMetric.Where(whereCondition.ToString());
        ...
        if(!string.IsNullOrEmpty(DataOrdering))
            lstT_DataMetric = Sorting.Sort<T_DataMetric>(lstT_DataMetric, DataOrdering);
        var _T_DataMetric = lstT_DataMetric;
        if(T_Hide != null)
        {
            try
            {
                bool boolvalue = Convert.ToBoolean(T_Hide);
                _T_DataMetric = _T_DataMetric.Where(o => o.T_Hide == boolvalue);
                ViewBag.SearchResult += "\r\n Hide?= " + T_Hide;
            }
            catch(Exception ex)
            {
        ...
        //if (lstT_DataMetric.Where(p => p.t_associateddatametrictype != null).Count() <= 50)
        //ViewBag.t_associateddatametrictype = new SelectList(lstT_DataMetric.Where(p => p.t_associateddatametrictype != null).Select(P => P.t_associateddatametrictype).Distinct(), "ID", "DisplayValue");
        if(t_associateddatametrictype != null)
        {
            var ids = t_associateddatametrictype.Split(",".ToCharArray());
            ...
            foreach(var str in ids)
            {
                ...
                if(!string.IsNullOrEmpty(str))
                {
                    ...
                    else
                    {
                        ...
                        var obj = db.T_DataMetrictypes.Find(Convert.ToInt64(str));
            ...
            ids1 = ids1.ToList();
            _T_DataMetric = _T_DataMetric.Where(p => ids1.Contains(p.T_AssociatedDataMetricTypeID));
        }
        _T_DataMetric = FilterByHostingEntity(_T_DataMetric, HostingEntity, AssociatedType, Convert.ToInt32(HostingEntityID));
        ...
        if(!Request.IsAjaxRequest())
        {
            ...
            if(!string.IsNullOrEmpty(GroupByColumn))
                foreach(var item in list)
                {
                    ...
                    item.m_DisplayValue = EntityComparer.GetGroupByDisplayValue(item, "T_DataMetric", tagsSplit.ToArray());
                }
    ...
    {
        return GraphHelper.ShowGraph(db, "T_DataMetric", type, inlarge);
    }
    ...
    {
        return GraphHelper.ShowGraphEntityHome(db, "T_DataMetric", type, inlarge, XAxis);
    }
    /// <summary>Appends where clause for HostingEntity (list inside tab or accordion).</summary>
    ///
    /// <param name="_T_DataMetric">IQueryable<T_DataMetric>.</param>
    /// <param name="HostingEntity">Name of Hosting Entity.</param>
    /// <param name="AssociatedType">Association Name.</param>
    /// <param name="HostingEntityID">Id of Hosting entity.</param>
    ///
    /// <returns>Modified LINQ IQueryable<T_DataMetric>.</returns>
    private IQueryable<T_DataMetric> FilterByHostingEntity(IQueryable<T_DataMetric> _T_DataMetric, string HostingEntity, string AssociatedType, int? HostingEntityID)
    {
        if(HostingEntity == "T_DataMetrictype" && AssociatedType == "T_AssociatedDataMetricType")
        {
            if(HostingEntityID != null)
            {
                ...
                _T_DataMetric = _T_DataMetric.Where(p => p.T_AssociatedDataMetricTypeID == hostid);
                ViewBag.HostingEntityIDData = db.T_DataMetrictypes.FirstOrDefault(fd => fd.Id == hostid);
            }
            else
                _T_DataMetric = _T_DataMetric.Where(p => p.T_AssociatedDataMetricTypeID == null);
        }
        return _T_DataMetric;
    }
    ...
    public string GetDisplayValue(string id)
    {
        ...
        {
            var _Obj = appcontext.T_DataMetrics.FirstOrDefault(p => p.Id == idvalue);
    ...
    public IQueryable<T_DataMetric> GetIQueryable(ApplicationContext appdb)
    {
        return appdb.T_DataMetrics.AsNoTracking();
    }
    ...
    public IQueryable<JournalEntry> GetExtraJournalEntry(int? id, Models.IUser user, JournalEntryContext jedb, string RelatedEntityRecords)
    {
        ...
        var t_datametric = jedb.T_DataMetrics.Find(id);
        if(RelatedEntityRecords == "T_DataMetric" || string.IsNullOrEmpty(RelatedEntityRecords))
        {
            predicateJournalEntry = predicateJournalEntry.Or(d => (d.EntityName == "Document" && d.Type != "View" && d.Type != "ViewList"));
        }
    ...
    public object GetRecordById(string id)
    {
        ...
        using(var appcontext = (new ApplicationContext(new SystemUser(), true)))
        {
            ...
            var _Obj = appcontext.T_DataMetrics.Find(Convert.ToInt64(id));
            return _Obj;
        }
    }
    ...
    {
        if(string.IsNullOrEmpty(id)) return Json(new T_DataMetric(), JsonRequestBehavior.AllowGet); ;
        using(var appcontext = (new ApplicationContext(new SystemUser(), true)))
        {
            appcontext.Configuration.LazyLoadingEnabled = false;
            var _Obj = appcontext.T_DataMetrics.Find(Convert.ToInt64(id));
    ...
    public string GetRecordById_Reflection(string id)
    {
        ...
        using(var context = (new ApplicationContext(new SystemUser(), true)))
        {
            ...
            var _Obj = context.T_DataMetrics.Find(Convert.ToInt64(id));
            return _Obj == null ? "" : EntityComparer.EnumeratePropertyValues<T_DataMetric>(_Obj, "T_DataMetric", new string[] { "" });
        }
    }
    /// <summary>Creates a JSON result with the given data as its content.</summary>
    ///
    ...
    {
        IQueryable<T_DataMetric> list = db.T_DataMetrics;
        FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
        list = _fad.FilterDropdown<T_DataMetric>(User, list, "T_DataMetric", caller);
    ...
    {
        var result = DropdownHelper.GetAllValue<T_DataMetric>(User, db.T_DataMetrics, caller, key, AssoNameWithParent, AssociationID, ExtraVal, "T_DataMetric", RestrictDropdownVal);
    ...
    {
        var result = DropdownHelper.GetAllValueForRB<T_DataMetric>(User, db.T_DataMetrics, caller, key, AssoNameWithParent, AssociationID, ExtraVal, "T_DataMetric");
        return Json(result.Select(x => new
        {
            Id = x.Id,
            Name = x.DisplayValue
    ...
    public JsonResult GetAllMultiSelectValue(string caller, string key, string AssoNameWithParent, string AssociationID)
    {
        ...
        var result = DropdownHelper.GetAllMultiSelectValue(User, db.T_DataMetrics, key, AssoNameWithParent, AssociationID, "T_DataMetric", caller);
        return Json(result.Select(x => new
        {
            Id = x.Id,
            Name = x.DisplayValue
    ...
    private string GetDisplayValueForImport(string AssociatedType, string HostingEntityID, string columnValue)
    {
        ...
        {
        case "T_AssociatedDataMetricTypeID":
            columnValue = db.T_DataMetrictypes.FirstOrDefault(p => p.Id == id).DisplayValue;
            break;
        default:
            break;
        }
    ...
    public ActionResult Upload(string FileType, string AssociatedType, string HostingEntityName, string HostingEntityID, string UrlReferrer)
    {
        ...
        {
            if(!((CustomPrincipal)User).CanUseVerb("ImportCSV", "T_DataMetric", User) || !User.CanAdd("T_DataMetric"))
            {
        ...
        {
            if(!((CustomPrincipal)User).CanUseVerb("ImportExcel", "T_DataMetric", User) || !User.CanAdd("T_DataMetric"))
            {
                return RedirectToAction("Index", "Error");
            }
        }
        ...
        //ViewBag.IsMapping = (db.ImportConfigurations.Where(p => p.Name == "T_DataMetric")).Count() > 0 ? true : false;
        var lstMappings = db.ImportConfigurations.Where(p => p.Name == "T_DataMetric").ToList();
    ...
    public ActionResult Upload([Bind(Include = "FileUpload")] HttpPostedFileBase FileUpload, FormCollection collection)
    {
        if(FileUpload != null)
        {
            ...
            if(fileExtension == ".xls" || fileExtension == ".xlsx" || fileExtension == ".csv" || fileExtension == ".all")
            {
                ...
                var entList = GeneratorBase.MVC.ModelReflector.Entities.FirstOrDefault(e => e.Name == "T_DataMetric");
                if(entList != null)
                {
                    var entityprop = entList.Properties.Where(p => p.Name != "DisplayValue" && p.Name != "TenantId" && p.Name != "IsDeleted" && p.Name != "DeleteDateTime");
                    string[] allcolumns = new string[] { "T_Name", "T_ToolTip", "T_AssociatedDataMetricTypeID", "T_Aggregate", "T_EntityName", "T_AggregatePropertyName", "T_Roles", "T_BackGroundColor", "T_FontColor", "T_Hide", "T_ClassIcon", "T_DisplayOrder", "T_DisplayOn" };
                ...
                if(!string.IsNullOrEmpty(collection["ListOfMappings"]))
                {
                    ...
                    {
                        var lstMapping = db.ImportConfigurations.Where(p => p.Name == "T_DataMetric" && p.IsDefaultMapping);
                    ...
                    DetailMessage = "We have received " + objDataSet.Tables[0].Rows.Count + " new <b>Data Metric</b>";
                    ...
                    if(entList != null)
                    {
                        ...
                        foreach(var association in entList.Associations)
                        {
                            ...
                            for(int i = 0; i < uniqueCols.Rows.Count; i++)
                            {
                                ...
                                {
                                case "T_AssociatedDataMetricTypeID":
                                    var t_associateddatametrictypeId = db.T_DataMetrictypes.FirstOrDefault(p => p.DisplayValue == assovalue);
                                    if(t_associateddatametrictypeId == null)
            ...
            if(entList != null)
            {
                ...
                foreach(var association in entList.Associations)
                {
                    ...
                    for(int i = 0; i < uniqueCols.Rows.Count; i++)
                    {
                        ...
                        {
                        case "T_AssociatedDataMetricTypeID":
                            var strPropertyT_AssociatedDataMetricType = lstEntityProp.FirstOrDefault(p => p.Key == "T_AssociatedDataMetricTypeID").Value;
                            ModelReflector.Property propT_AssociatedDataMetricType = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_DataMetrictype").Properties.FirstOrDefault(p => p.DisplayName == strPropertyT_AssociatedDataMetricType);
                            var t_associateddatametrictypeId = db.T_DataMetrictypes.Where(propT_AssociatedDataMetricType.Name + "=(@0)", assovalue).FirstOrDefault();
                            //var t_associateddatametrictypeId = db.T_DataMetrictypes.Where(propT_AssociatedDataMetricType.Name+"=\""+assovalue+"\"").FirstOrDefault();
                            if(t_associateddatametrictypeId == null)
                                uniqueassoValues.Add(assovalue);
                            break;
                        default:
        ...
        if(fileExtension == ".xls" || fileExtension == ".xlsx" || fileExtension == ".csv")
        {
            ...
            if(objDataSet != null && objDataSet.Tables.Count > 0 && selectedlist != null && columnlist != null)
            {
                ...
                for(int i = 0; i < objDataSet.Tables[0].Rows.Count; i++)
                {
                    if(AreAllColumnsEmpty(objDataSet.Tables[0].Rows[i], sheetColumns))
                        continue;
                    T_DataMetric model = new T_DataMetric();
                    ...
                    for(int j = 0; j < sheetColumns.Count; j++)
                    {
                        ...
                        case "T_ToolTip":
                            ...
                            break;
                        case "T_Aggregate":
                            model.T_Aggregate = columnValue;
                            break;
                        case "T_EntityName":
                            model.T_EntityName = columnValue;
                            break;
                        case "T_AggregatePropertyName":
                            model.T_AggregatePropertyName = columnValue;
                            break;
                        case "T_Roles":
                            model.T_Roles = columnValue;
                            break;
                        ...
                        case "T_FontColor":
                            ...
                            break;
                        case "T_Hide":
                            model.T_Hide = Boolean.Parse(columnValue);
                            break;
                        case "T_ClassIcon":
                            model.T_ClassIcon = columnValue;
                            break;
                        case "T_DisplayOrder":
                            model.T_DisplayOrder = Int32.Parse(columnValue);
                            break;
                        case "T_DisplayOn":
                            model.T_DisplayOn = columnValue;
                            break;
                        case "T_AssociatedDataMetricTypeID":
                            dynamic t_associateddatametrictypeId = null;
                            if(AssociatedType != null && AssociatedType == "T_AssociatedDataMetricType" && HostingEntityID != null)
                            {
                                long id = Convert.ToInt64(HostingEntityID);
                                model.T_AssociatedDataMetricTypeID = id;
                            }
                            else
                            {
                                if(lstEntityProp.Count > 0)
                                {
                                    var strPropertyT_AssociatedDataMetricType = lstEntityProp.FirstOrDefault(p => p.Key == "T_AssociatedDataMetricTypeID").Value;
                                    ModelReflector.Property propT_AssociatedDataMetricType = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_DataMetrictype").Properties.FirstOrDefault(p => p.DisplayName == strPropertyT_AssociatedDataMetricType);
                                    if(propT_AssociatedDataMetricType.Name == "DisplayValue")
                                        t_associateddatametrictypeId = db.T_DataMetrictypes.AsNoTracking().FirstOrDefault(p => p.DisplayValue == columnValue);
                                    else
                                        t_associateddatametrictypeId = db.T_DataMetrictypes.AsNoTracking().Where(propT_AssociatedDataMetricType.Name + "=\"" + columnValue + "\"").FirstOrDefault();
                                }
                                else
                                    t_associateddatametrictypeId = db.T_DataMetrictypes.AsNoTracking().FirstOrDefault(p => p.DisplayValue == columnValue);
                            }
                            if(t_associateddatametrictypeId != null)
                                model.T_AssociatedDataMetricTypeID = t_associateddatametrictypeId.Id;
                            else
                            {
                                if((collection["T_AssociatedDataMetricTypeID"] != null) && (collection["T_AssociatedDataMetricTypeID"].ToString() == "true,false"))
                                {
                                    try
                                    {
                                        T_DataMetrictype objT_DataMetrictype = new T_DataMetrictype();
                                        objT_DataMetrictype.T_Name = (columnValue);
                                        db.T_DataMetrictypes.Add(objT_DataMetrictype);
                                        try
                                        {
                                            db.SaveChanges();
                                        }
                                        ...
                                        {
                                            db.Entry(objT_DataMetrictype).State = EntityState.Detached;
                                            continue;
                                        }
                                        model.T_AssociatedDataMetricTypeID = objT_DataMetrictype.Id;
                                    }
                                    catch
                                    {
                                        continue;
                    ...
                    var flagUpdate = MatchUpdate.Update(model, MatchColumns, db, "T_DataMetric", mappedColumns);
                    ...
                    if(AlrtMsg == "")
                    {
                        ...
                        {
                            var result = CheckMandatoryProperties(User, db, model, "T_DataMetric");
                            var validatebr_result = GetValidateBeforeSavePropertiesDictionary(User, db, model, "OnCreate", "T_DataMetric");
    ...
    [AcceptVerbs(HttpVerbs.Get)]
    public JsonResult GetAggregateProperties(long id)
    {
        string entityname = db.T_FacetedSearchs.Where(p => p.Id == id).FirstOrDefault().T_EntityName;
        var entity = ModelReflector.Entities.FirstOrDefault(p => p.Name == entityname);
        var properties = entity.Properties.Where(p => p.DataType.ToLower() == "decimal" || p.DataType.ToLower() == "long" || p.DataType.ToLower() == "int" || p.DataType.ToLower() == "double");
    ...
    public object GetFieldValueByEntityId(long Id, string PropName)
    {
        try
        {
            using(var appcontext = (new ApplicationContext(new SystemUser(), true)))
            {
                var obj1 = appcontext.T_DataMetrics.Where(p => p.Id == Id).FirstOrDefault();
    ...
    private JsonResult ApplyBusinessRuleOnSaving(T_DataMetric t_datametric)
    {
        ...
        if((businessrule != null && businessrule.Count > 0))
        {
            ...
            {
                var resultBR = GetValidateBeforeSavePropertiesDictionary(User, db, t_datametric, "OnEdit", "T_DataMetric");
                if(resultBR.Count() > 0)
                {
                    string stringResult = "";
            ...
            {
                var resultBR = GetMandatoryPropertiesDictionary(User, db, t_datametric, "OnEdit", "T_DataMetric");
                if(resultBR.Count() > 0)
                {
                    string stringResult = "";
                    string BRID = "";
                    foreach(var dic in resultBR)
                    {
                        ...
                        {
                            var type = t_datametric.GetType();
                            if(type.GetProperty(dic.Key) != null)
                            {
                                var propertyvalue = type.GetProperty(dic.Key).GetValue(t_datametric, null);
            ...
            {
                var resultBR = GetValidateBeforeSavePropertiesDictionaryForPopupConfirm(User, db, t_datametric, "OnEdit", "T_DataMetric");
                if(resultBR.Count() > 0)
                {
                    string stringResult = "";
                    foreach(var dic in resultBR)
    ...
    private JsonResult ApplyBusinessRuleBefore(T_DataMetric t_datametric, bool IsReadOnlyIgnore = false)
    {
        var businessrule = User.businessrules.Where(p => p.EntityName == "T_DataMetric").ToList();
        if((businessrule != null && businessrule.Count > 0))
        {
            ...
            {
                var validateLockResult = GetLockBusinessRulesDictionary(User, db, t_datametric, "T_DataMetric").Where(p => p.Key.Contains("FailureMessage"));
            ...
            {
                var validateMandatorypropertyResult = GetReadOnlyPropertiesDictionary(User, db, t_datametric, "T_DataMetric").Where(p => p.Key.Contains("FailureMessage"));
    ...
    [HttpPost]
    [Audit(0)]
    public JsonResult GetReadOnlyProperties(T_DataMetric OModel)
    {
        OModel = UpdateHiddenProperties(OModel, string.Join(",", User.CanNotView("T_DataMetric")));
        return Json(GetReadOnlyPropertiesDictionary(User, db, OModel, "T_DataMetric"), JsonRequestBehavior.AllowGet);
    }
    ...
    [HttpPost]
    [Audit(0)]
    public JsonResult GetMandatoryProperties(T_DataMetric OModel, string ruleType)
    {
        OModel = UpdateHiddenProperties(OModel, string.Join(",", User.CanNotView("T_DataMetric")));
        return Json(GetMandatoryPropertiesDictionary(User, db, OModel, ruleType, "T_DataMetric"), JsonRequestBehavior.AllowGet);
    }
    ...
    [HttpPost]
    [Audit(0)]
    public JsonResult GetUIAlertBusinessRules(T_DataMetric OModel, string ruleType)
    {
        Dictionary<string, string> RulesApplied = new Dictionary<string, string>();
        var conditions = "";
        if(User.businessrules != null)
        {
            var BR = User.businessrules.Where(p => p.EntityName == "T_DataMetric").ToList();
            var BRAll = BR;
            ...
            if(BR != null && BR.Count > 0)
            {
                ...
                var ResultOfBusinessRules = db.UIAlertRule(OModel, BR, "T_DataMetric");
    ...
    ///
    /// <returns>T_DataMetric object.</returns>
    public T_DataMetric UpdateHiddenProperties(T_DataMetric OModel, string cannotview = null)
    {
        Dictionary<string, string> hiddenProperties = new Dictionary<string, string>();
        if(OModel.Id > 0 && !string.IsNullOrEmpty(cannotview))
            using(var context = (new ApplicationContext(new SystemUser(), true)))
            {
                var obj1 = context.T_DataMetrics.Find(OModel.Id);
                if(obj1 != null)
                {
    ...
    [HttpPost]
    [Audit(0)]
    public JsonResult GetValidateBeforeSaveProperties(T_DataMetric OModel, string ruleType)
    {
        OModel = UpdateHiddenProperties(OModel, string.Join(",", User.CanNotView("T_DataMetric")));
        return Json(GetValidateBeforeSavePropertiesDictionary(User, db, OModel, ruleType, "T_DataMetric"), JsonRequestBehavior.AllowGet);
    }
    /// <summary>(An Action that handles HTTP POST requests) creates a JSON result (Before save business rule).</summary>
    ///
    /// <param name="OModel">  The model.</param>
    ...
    [HttpPost]
    [Audit(0)]
    public JsonResult GetValidateBeforeSavePropertiesForPopupConfirm(T_DataMetric OModel, string ruleType)
    {
        OModel = UpdateHiddenProperties(OModel, string.Join(",", User.CanNotView("T_DataMetric")));
        return Json(GetValidateBeforeSavePropertiesDictionaryForPopupConfirm(User, db, OModel, ruleType, "T_DataMetric"), JsonRequestBehavior.AllowGet);
    }
    ...
    [Audit(0)]
    [ValidateAntiForgeryToken]
    public JsonResult GetLockBusinessRules(T_DataMetric OModel)
    {
        OModel = UpdateHiddenProperties(OModel, string.Join(",", User.CanNotView("T_DataMetric")));
        return Json(GetLockBusinessRulesDictionary(User, db, OModel, "T_DataMetric"), JsonRequestBehavior.AllowGet);
    }
    ...
    public long? GetIdFromDisplayValue(string displayvalue)
    {
        ...
        using(ApplicationContext db1 = new ApplicationContext(new SystemUser()))
        {
            ...
            var _Obj = db1.T_DataMetrics.FirstOrDefault(p => p.DisplayValue == displayvalue);
            long outValue;
            if(_Obj != null)
    ...
    public long? GetIdFromPropertyValue(string PropName, string PropValue)
    {
        using(var context = (new ApplicationContext(new SystemUser(), true)))
        {
            IQueryable query = context.T_DataMetrics;
            Type[] exprArgTypes = { query.ElementType };
            string propToWhere = PropName;
            ParameterExpression p = Expression.Parameter(typeof(T_DataMetric), "p");
            MemberExpression member = Expression.PropertyOrField(p, propToWhere);
            LambdaExpression lambda = null;
            if(PropValue.ToLower().Trim() != "null")
                lambda = Expression.Lambda<Func<T_DataMetric, bool>>(Expression.Equal(member, Expression.Convert(Expression.Constant(PropValue), member.Type)), p);
            else
                lambda = Expression.Lambda<Func<T_DataMetric, bool>>(Expression.Equal(member, Expression.Constant(null, member.Type)), p);
            MethodCallExpression methodCall = Expression.Call(typeof(Queryable), "Where", exprArgTypes, query.Expression, lambda);
            IQueryable q = query.Provider.CreateQuery(methodCall);
            long outValue;
            var list1 = ((IQueryable<T_DataMetric>)q);
    ...
    public JsonResult GetPropertyValueByEntityId(long Id, string PropName)
    {
        using(var context = (new ApplicationContext(new SystemUser(), true)))
        {
            var obj1 = context.T_DataMetrics.Find(Id);
            if(obj1 == null)
    ...
    public void SetPropertyValueByEntityId(long Id, string PropName, string value)
    {
        using(var context = (new ApplicationContext(new SystemUser(), true)))
        {
            T_DataMetric obj1 = context.T_DataMetrics.Find(Id);
            if(obj1 != null)
            {
    ...
    [HttpPost]
    public JsonResult Check1MThresholdValue(T_DataMetric t_datametric)
    {
    ...
    {
        string[][] groupsarr = new string[][] { new string[] { "55862", "Basic Information" }, new string[] { "55863", "Metric Display Information" }, new string[] { "55865", "UI Information" } };
        return groupsarr;
    }
    ...
    [ValidateAntiForgeryToken]
    [Audit(0)]
    public ActionResult GetCalculationValues(T_DataMetric t_datametric)
    {
        t_datametric.setCalculation();
        Dictionary<string, string> Calculations = new Dictionary<string, string>();
        System.Reflection.PropertyInfo[] properties = (t_datametric.GetType()).GetProperties().Where(p => p.PropertyType.FullName.StartsWith("System")).ToArray();
    ...
    [ValidateAntiForgeryToken]
    [Audit(0)]
    public ActionResult GetDerivedDetails(T_DataMetric t_datametric, string IgnoreEditable = null, string source = null)
    {
    ...
    [ValidateAntiForgeryToken]
    [Audit(0)]
    public ActionResult GetDerivedDetailsInline(string host, string value, T_DataMetric t_datametric, string IgnoreEditable)
    {
        Dictionary<string, string> derivedlist = new Dictionary<string, string>();
        return Json(derivedlist, "application/json", System.Text.Encoding.UTF8, JsonRequestBehavior.AllowGet);
    }
