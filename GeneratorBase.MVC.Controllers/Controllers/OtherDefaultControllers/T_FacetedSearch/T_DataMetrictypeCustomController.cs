...
{
/// <summary>A controller for DataMetric Type.</summary>
///
/// <remarks></remarks>
public partial class T_DataMetrictypeController : BaseController
{
    ...
    public bool CheckBeforeDelete(T_DataMetrictype t_datametrictype)
    {
        var result = true;
    ...
    public string CheckBeforeSave(T_DataMetrictype t_datametrictype, string command ="")
    {
        var AlertMsg = "";
        // Write your logic here
    ...
    public void OnDeleting(T_DataMetrictype t_datametrictype, ApplicationContext unitdb, GeneratorBase.MVC.Models.IUser ondeletinguser)
    {
        // Write your logic here
    }
    ...
    public void OnSaving(T_DataMetrictype t_datametrictype, ApplicationContext db, GeneratorBase.MVC.Models.IUser onsavinguser)
    {
        // Write your logic here
    }
    ...
    public void AfterSave(T_DataMetrictype t_datametrictype, GeneratorBase.MVC.Models.IUser aftersaveuser, EntityState entityState)
    {
        // Write your logic here
    }
...
/// <summary>Custom load view data list after on create.</summary>
    ...
    private void CustomLoadViewDataListAfterOnCreate(T_DataMetrictype t_datametrictype)
    {
    }
/// <summary>Custom load view data list before edit.</summary>
    ///
    /// <param name="t_datametrictype">The DataMetric Type.</param>
    private void CustomLoadViewDataListBeforeEdit(T_DataMetrictype t_datametrictype)
    {
    }
/// <summary>Custom load view data list after edit.</summary>
    ///
    /// <param name="t_datametrictype">The DataMetric Type.</param>
    private void CustomLoadViewDataListAfterEdit(T_DataMetrictype t_datametrictype)
    {
    }
/// <summary>Custom load view data list on index.</summary>
    ...
    ///
    /// <returns>True if it succeeds, false if it fails.</returns>
    private bool CustomSaveOnCreate(T_DataMetrictype t_datametrictype, out bool customcreate_hasissues, string command="")
    {
        var result = false;
...
/// <summary>Custom save on edit.</summary>
    ...
    ///
    /// <returns>True if it succeeds, false if it fails.</returns>
    private bool CustomSaveOnEdit(T_DataMetrictype t_datametrictype, out bool customsave_hasissues, string command="")
    {
        var result = false;
...
/// <summary>Custom save on import.</summary>
    ...
    ///
    /// <returns>True if it succeeds, false if it fails.</returns>
    private bool CustomSaveOnImport(T_DataMetrictype t_datametrictype, out string customerror, int i)
    {
        var result = false;
        customerror = "";
        return result;
...
/// <summary>Custom import data validate.</summary>
    ...
    ///
    /// <returns>True if it succeeds, false if it fails.</returns>
    private bool CustomDelete(T_DataMetrictype t_datametrictype, out bool customdelete_hasissues, string command="")
    {
        var result = false;
    ...
    ///
    /// <param name="list">          The IQueryable<T_DataMetrictype> list.</param>
    /// <param name="HostingEntity"> The hosting entity.</param>
    /// <param name="AssociatedType">Type of the associated.</param>
    /// <param name="sortBy">        Describes who sort this object.</param>
    /// <param name="isAsc">         The is ascending.</param>
    ///
    /// <returns>An IQueryable<T_DataMetrictype></returns>
    private IQueryable<T_DataMetrictype> CustomSorting(IQueryable<T_DataMetrictype> list, string HostingEntity, string AssociatedType, string sortBy, string isAsc)
    {
        IQueryable<T_DataMetrictype> orderedList = list;
...
/// <summary>Creates a result that redirects to the given route.</summary>
    ...
    private RedirectToRouteResult CustomRedirectUrl(T_DataMetrictype t_datametrictype,string action,string command="", string viewmode="")
    {
        // Sample Custom implemention below
        // return RedirectToAction("Index", "T_DataMetrictype");
        return null;
    }
}
}
