...
{
/// <summary>A controller for handling data source parameters.</summary>
public partial class DataSourceParametersController : BaseController
{
    /// <summary>GET: /DataSourceParameters/.</summary>
    ///
    ...
    public ActionResult Index(string currentFilter, string searchString, string sortBy, string isAsc, int? page, int? itemsPerPage, string HostingEntity, int? HostingEntityID, string AssociatedType, bool? IsExport, bool? IsDeepSearch, bool? IsFilter, bool? RenderPartial, string BulkOperation,string parent,string Wfsearch,string caller, bool? BulkAssociate)
    {
        ...
        {
            if(Request.Cookies["pageSize" + HttpUtility.UrlEncode(User.Name) + "DataSourceParameters"].Value != "null")
        ...
        {
            if(Request.Cookies["pagination" + HttpUtility.UrlEncode(User.Name) + "DataSourceParameters"].Value != "null")
    ...
    /// <summary>GET: /DataSourceParameters/Details/5.</summary>
    ///
    ...
    /// <summary>GET: /DataSourceParameters/Create.</summary>
    ///
    ...
    /// <summary>GET: /DataSourceParameters/CreateWizard.</summary>
    ///
    /// <param name="UrlReferrer">      The URL referrer.</param>
    /// <param name="HostingEntityName">Name of the hosting entity.</param>
    /// <param name="HostingEntityID">  Identifier for the hosting entity.</param>
    ...
    /// <summary>POST: /DataSourceParameters/CreateWizard To protect from overposting attacks, please
    ...
    ///
    /// <param name="datasourceparameters">The datasourceparameters.</param>
    /// <param name="UrlReferrer">         The URL referrer.</param>
    ///
    /// <returns>A response stream to send to the CreateWizard View.</returns>
    ...
    /// <summary>GET: /DataSourceParameters/CreateQuick.</summary>
    ///
    /// <param name="UrlReferrer">      The URL referrer.</param>
    /// <param name="HostingEntityName">Name of the hosting entity.</param>
    /// <param name="HostingEntityID">  Identifier for the hosting entity.</param>
    ...
    /// <summary>POST: /DataSourceParameters/CreateQuick To protect from overposting attacks, please
    /// enable the specific properties you want to bind to, for more details see
    /// http://go.microsoft.com/fwlink/?LinkId=317598.</summary>
    ///
    /// <param name="datasourceparameters">The datasourceparameters.</param>
    ...
    /// <summary>POST: /DataSourceParameters/Create To protect from overposting attacks, please enable
    ...
    /// <summary>GET: /DataSourceParameters/Edit/5.</summary>
    ///
    /// <param name="id">               The Identifier to delete.</param>
    /// <param name="UrlReferrer">      The URL referrer.</param>
    /// <param name="HostingEntityName">Name of the hosting entity.</param>
    ...
    /// <summary>POST: /DataSourceParameters/Edit/5 To protect from overposting attacks, please enable
    /// the specific properties you want to bind to, for more details see
    /// http://go.microsoft.com/fwlink/?LinkId=317598.</summary>
    ///
    /// <param name="datasourceparameters">The datasourceparameters.</param>
    ...
    /// <summary>GET: /DataSourceParameters/EditWizard/5.</summary>
    ///
    /// <param name="id">         The Identifier to delete.</param>
    /// <param name="UrlReferrer">The URL referrer.</param>
    ///
    ...
    /// <summary>POST: /DataSourceParameters/EditWizard/5 To protect from overposting attacks, please
    /// enable the specific properties you want to bind to, for more details see
    /// http://go.microsoft.com/fwlink/?LinkId=317598.</summary>
    ///
    /// <param name="datasourceparameters">The datasourceparameters.</param>
    ...
    /// <summary>GET: /DataSourceParameters/Delete/5.</summary>
    ///
    ...
    /// <summary>POST: /DataSourceParameters/Delete/5.</summary>
    ///
    /// <param name="datasourceparameters">The datasourceparameters.</param>
    /// <param name="UrlReferrer">         The URL referrer.</param>
    ///
