...
public partial class DataSourceParametersController : BaseController
{
    ...
    ///
    /// <param name="lstDataSourceParameters">Options for controlling the list data source.</param>
    ...
    /// <param name="entitydatasourceparameters">The entitydatasourceparameters.</param>
    ///
    ...
    /// <summary>GET: /DataSourceParameters/FSearch/.</summary>
    ///
    ...
    public void OnSaving(DataSourceParameters datasourceparameters, ApplicationContext db, GeneratorBase.MVC.Models.IUser onsavinguser)
    {
        // Write your logic here
    }
    ...
    public void AfterSave(DataSourceParameters datasourceparameters, GeneratorBase.MVC.Models.IUser aftersaveuser, EntityState entityState)
    {
        // Write your logic here
    }
