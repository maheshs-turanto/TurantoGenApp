...
public class DailyRecurrenceSettings : RecurrenceSettings
{
    ...
    /// <summary>The regen every x coordinate in days.</summary>
    ...
    /// <summary>The final next date value Date/Time.</summary>
    DateTime finalNextDateValue;
    #endregion
    
    #region Public GetValues
    
    /// <summary>Get day values. This overload is for every x-days.</summary>
    ///
    ...
    /// <summary>An overload to use to get either every weekday or just every x-days.</summary>
    ///
    /// <param name="regenEveryXDays">  <para>
    ///                                     Interval of days. Every x-days.
    ///                                 </para></param>
    /// <param name="regenType">        <para>
    ///                                     Type of regeneration to perform. Every x-days or every
    ///                                     weekday.
    ///                                 </para></param>
    ///
    ...
    /// <summary>Gets friendly recurrence information.</summary>
    ///
    /// <param name="seriesInfo">Information describing the series.</param>
    ///
    /// <returns>The friendly recurrence information.</returns>
    ...
    /// <summary>Get day values. Default is to get every weekday. This is called from the
    ...
    /// <summary>Get the values for just weekdays.</summary>
    ///
    ...
    /// <summary>Get the next Weekday value. This will increment the input date until it finds the
    /// next non-Saturday and non-Sunday dates.</summary>
    ///
    ...
    /// <summary>Get dates for every x-days starting from the start date.</summary>
    ///
    /// <exception cref="Exception">                Thrown when an exception error condition occurs.</exception>
    /// <exception cref="ArgumentNullException">    Thrown when one or more required arguments are
    ///                                             null.</exception>
    ///
    /// <returns>The every x coordinate days values.</returns>
    ...
    /// <summary>What is the interval to generate dates. This is used to skip days in the cycle.</summary>
    ///
    /// <value>The regen every x coordinate days.</value>
