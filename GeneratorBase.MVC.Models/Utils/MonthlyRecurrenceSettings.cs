...
/// <summary>The Regeneration type. Is this on a specific day of the month, a custom date, or
/// after the occurrence is completed.</summary>

public enum MonthlyRegenType { NotSet = -1, OnSpecificDayOfMonth, OnCustomDateFormat, AfterOccurrenceCompleted };
/// <summary>First part of a custom date. This would be First, Second, etc. item of the month.</summary>
public enum MonthlySpecificDatePartOne { NotSet = -1, First, Second, Third, Fourth, Last };
/// <summary>Second part of a custom date. This is day of week, weekend day, etc.</summary>
...
/// <summary>A monthly recurrence settings.</summary>
public class MonthlyRecurrenceSettings : RecurrenceSettings
{
    #region Constructors
    
    /// <summary>Get dates by Start date only. This is for no ending date values.</summary>
    ///
    /// <param name="startDate">.</param>
    
    public MonthlyRecurrenceSettings(DateTime startDate) : base(startDate) { }
    
    /// <summary>Get dates by Start and End date boundries.</summary>
    ///
    /// <param name="startDate">.</param>
    ...
    /// <summary>Get dates by Start date and number of occurrences.</summary>
    ///
    /// <param name="startDate">          .</param>
    ...
    /// <summary>The regenerate on specific date day value.</summary>
    int regenerateOnSpecificDateDayValue;
    /// <summary>The regen every x coordinate in months.</summary>
    int regenEveryXMonths = 1;
    /// <summary>The adjustment value.</summary>
    int adjustmentValue;
    /// <summary>True to get next date value.</summary>
    bool getNextDateValue;
    /// <summary>The next date value Date/Time.</summary>
    DateTime nextDateValue;
    /// <summary>Type of the regen.</summary>
    MonthlyRegenType regenType = MonthlyRegenType.NotSet;
    /// <summary>The specific date part one.</summary>
    MonthlySpecificDatePartOne specificDatePartOne = MonthlySpecificDatePartOne.NotSet;
    /// <summary>The specific date part two.</summary>
    MonthlySpecificDatePartTwo specificDatePartTwo = MonthlySpecificDatePartTwo.NotSet;
    #endregion
    
    #region Private Procedures
    
    /// <summary>Get the Series information that's used to get dates at a later date. This is passed
    /// into the RecurrenceHelper to get date values. Most likely used for non-ending dates.</summary>
    ///
    ...
    /// <summary>Get recurring dates from a specific constant date such as 27 July.</summary>
    ///
    /// <exception cref="Exception">                Thrown when an exception error condition occurs.</exception>
    /// <exception cref="ArgumentNullException">    Thrown when one or more required arguments are
    ///                                             null.</exception>
    ///
    /// <returns>The specific day of month dates.</returns>
    ...
    /// <summary>Correct an input date to be equal to or less than the specified day value.</summary>
    ///
    /// <param name="input">    Date to check to ensure it matches the specified day value or the max
    ///                         number of days for that month, whichever comes first.</param>
    ///
    ...
    /// <summary>Get recurring dates from custom date such as First Sunday of July.</summary>
    ///
    /// <exception cref="Exception">                Thrown when an exception error condition occurs.</exception>
    /// <exception cref="ArgumentNullException">    Thrown when one or more required arguments are
    ///                                             null.</exception>
    ///
    /// <returns>The custom day of month dates.</returns>
    ...
    /// <summary>Get the custom value from the 1st, 2nd, and 3rd custom date parts.</summary>
    ///
    /// <param name="currentDate">The current date.</param>
    ///
    /// <returns>The custom date.</returns>
    ///
    ...
    /// <summary>Gets custom weekday.</summary>
    ///
    /// <param name="startDate">    .</param>
    /// <param name="weekDay">      The week day.</param>
    /// <param name="daysOfMonth">  The days of month.</param>
    /// <param name="firstDatePart">The first date part.</param>
    ///
    /// <returns>The custom weekday.</returns>
    ...
    /// <summary>Get a user-friendly class that is a easy way using Properties that define the Series
    /// Info.</summary>
    ///
    /// <param name="seriesInfo">   <para>
    ///                                 String of Series Info that was first generated by this
    ///                                 MonthlyRecurrenceSettings Class object.
    ///                             </para></param>
    ///
    /// <returns>A RecurrenceGenerator.RecurrenceInfo value...</returns>
    ...
    /// <summary>Get Custom dates such as Last Saturday of the month with option as to the increment
    /// of every x-months.</summary>
    ///
    /// <param name="customDatePartOne">Corresponds to Part of month such as First, Last.</param>
    /// <param name="customDatePartTwo">    Corresponds to day of the week to get such as Tuesday or
    ///                                     Weekend Day.</param>
    ...
    /// <summary>Get values for a specific day of the month. Eg. Every 23rd day. With option to get
    /// every x-month.</summary>
    ///
    /// <param name="dayOfMonthToRegen">    Day of month you want to set as the value to get from
    ///                                     month to month.</param>
    /// <param name="regenEveryXMonths">    How many months to skip, such as 2 for every other month.</param>
    ///
    /// <returns>The values.</returns>
    ...
    /// <summary>What is the first part to the Custom date such as First, Last.</summary>
    ///
    /// <value>The specific date part one.</value>
    ...
    /// <summary>What is the second part to the Custom date such as which weekday, weekend day, etc.</summary>
    ///
    /// <value>The specific date part two.</value>
    ...
    /// <summary>What is the regeneration type such as Specific day of month, custom date, etc.</summary>
    ///
    /// <value>The type of the regen.</value>
    ...
    /// <summary>Day of month to regenerate when RegenType = specific day of month.</summary>
    ///
    /// <value>The regenerate on specific date day value.</value>
    ...
    /// <summary>Used to adjust the date plus/minus x-days.</summary>
    ///
    ...
    /// <summary>What is the interval to generate dates. This is used to skip months in the cycle.</summary>
    ///
    /// <value>The regen every x coordinate months.</value>
    ...
    /// <summary>Final overloaded function that gets the Recurrence Values. This is called from the
    /// RecurrenceHelper staic methods only.</summary>
    ///
    /// <returns>A RecurrenceGenerator.RecurrenceValues value...</returns>
    ...
    /// <summary>Gets recurrence values.</summary>
    ///
    /// <returns>The recurrence values.</returns>
    ...
    /// <summary>Gets pattern definition.</summary>
    ///
    /// <param name="seriesInfo">   <para>
    ///                                 String of Series Info that was first generated by this
    ///                                 MonthlyRecurrenceSettings Class object.
    ...
    /// <summary>Gets recurrence settings.</summary>
    ///
    /// <param name="seriesInfo">   <para>
    ///                             String of Series Info that was first generated by this
    ///                             MonthlyRecurrenceSettings Class object.
    ///                             </para></param>
    ///
    /// <returns>The recurrence settings.</returns>
    ...
    /// <summary>Gets recurrence settings.</summary>
    ///
    /// <param name="modifiedStartDate">The modified start date.</param>
    /// <param name="seriesInfo">           <para>
    ///                                     String of Series Info that was first generated by this
    ///                                     MonthlyRecurrenceSettings Class object.
    ///                                     </para></param>
    ...
    ///
    /// <param name="seriesInfo">               <para>
    ///                                         String of Series Info that was first generated by
    ///                                         this MonthlyRecurrenceSettings Class object.
    ///                                         </para></param>
    /// <param name="modifiedOccurrencesValue">The modified occurrences value.</param>
    ///
    /// <returns>The recurrence settings.</returns>
    ...
    ///                                 MonthlyRecurrenceSettings Class object.
    ///                                 </para></param>
    /// <param name="modifiedEndDate">The modified end date.</param>
    ///
    /// <returns>The recurrence settings.</returns>
