...
{
public class T_ExportDataDetailsIndexArgsOption : IndexArgsOption
{

    public string t_exportdataconfigurationexportdatadetailsassociation
    {
        get;
        set;
    }
    public string T_IsNested
    {
        get;
        set;
    }
...
public class T_ExportDataDetailsIndexViewModel : T_ExportDataDetailsIndexArgsOption
{
    public IPagedList<T_ExportDataDetails> list
    {
        get;
        set;
    }
    public T_ExportDataDetailsIndexViewModel(IUser User, T_ExportDataDetailsIndexArgsOption args)
    {
        args.EntityName = "T_ExportDataDetails";
        ...
        var templatename = EntityDefaultPageHelper.GetTemplatesForList(User, "T_ExportDataDetails", args.viewtype);
