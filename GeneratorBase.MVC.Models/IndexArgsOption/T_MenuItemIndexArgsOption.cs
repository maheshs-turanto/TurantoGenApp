...
{
public class T_MenuItemIndexArgsOption : IndexArgsOption
{

    public string t_menuitemmenuitemassociation
    {
        get;
        set;
...
public class T_MenuItemIndexViewModel : T_MenuItemIndexArgsOption
{
    public IPagedList<T_MenuItem> list
    {
        get;
        set;
    }
    public T_MenuItemIndexViewModel(IUser User, T_MenuItemIndexArgsOption args)
    {
        args.EntityName = "T_MenuItem";
        ...
        var templatename = EntityDefaultPageHelper.GetTemplatesForList(User, "T_MenuItem", args.viewtype);
