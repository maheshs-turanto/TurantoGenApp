...
{
public class FileDocumentIndexArgsOption : IndexArgsOption
{
    ...
    } public string DateCreatedTo
    {
        get;
        set;
    } public string DateLastUpdatedFrom
    {
        get;
        set;
    } public string DateLastUpdatedTo
    {
        get;
        set;
    }
    public string DateCreatedFromhdn
    {
        get;
        set;
    } public string DateCreatedTohdn
    {
        get;
        set;
    } public string DateLastUpdatedFromhdn
    {
        get;
        set;
    } public string DateLastUpdatedTohdn
    {
        get;
        set;
    }
...
public class FileDocumentIndexViewModel : FileDocumentIndexArgsOption
{
    public IPagedList<FileDocument> list
    {
        get;
        set;
    }
    public FileDocumentIndexViewModel(IUser User, FileDocumentIndexArgsOption args)
    {
        ...
        var templatename = EntityDefaultPageHelper.GetTemplatesForList(User, "FileDocument", args.viewtype);
