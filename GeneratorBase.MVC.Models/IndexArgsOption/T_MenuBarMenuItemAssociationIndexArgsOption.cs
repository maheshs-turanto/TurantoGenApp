...
{
public class T_MenuBarMenuItemAssociationIndexArgsOption : IndexArgsOption
{

    public string t_menubar
    {
        get;
        set;
    } public string t_menuitem
    {
        get;
        set;
    }
    
    public string T_OrderNumberFrom
    {
        get;
        set;
    }
    public string T_OrderNumberTo
    {
        get;
        set;
    }
...
public class T_MenuBarMenuItemAssociationIndexViewModel : T_MenuBarMenuItemAssociationIndexArgsOption
{
    public IPagedList<T_MenuBarMenuItemAssociation> list
    {
        get;
        set;
    }
    public T_MenuBarMenuItemAssociationIndexViewModel(IUser User, T_MenuBarMenuItemAssociationIndexArgsOption args)
    {
        args.EntityName = "T_MenuBarMenuItemAssociation";
        ...
        var templatename = EntityDefaultPageHelper.GetTemplatesForList(User, "T_MenuBarMenuItemAssociation", args.viewtype);
