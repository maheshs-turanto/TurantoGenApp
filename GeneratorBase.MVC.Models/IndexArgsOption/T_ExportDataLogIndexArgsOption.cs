...
{
public class T_ExportDataLogIndexArgsOption : IndexArgsOption
{

    public string t_exportdataconfigurationexportdatalogassociation
    {
        get;
        set;
    } public string t_associatedexportdatalogstatus
    {
        get;
        set;
    }
...
public class T_ExportDataLogIndexViewModel : T_ExportDataLogIndexArgsOption
{
    public IPagedList<T_ExportDataLog> list
    {
        get;
        set;
    }
    public T_ExportDataLogIndexViewModel(IUser User, T_ExportDataLogIndexArgsOption args)
    {
        args.EntityName = "T_ExportDataLog";
        ...
        var templatename = EntityDefaultPageHelper.GetTemplatesForList(User, "T_ExportDataLog", args.viewtype);
