...
{
/// <summary>A feedback severity.</summary>
[Table("tbl_FeedbackSeverity")]
public class FeedbackSeverity : EntityDefault
{
    ...
    public virtual ICollection<ApplicationFeedback> applicationfeedbackseverity
    {
        get;
        set;
    }
