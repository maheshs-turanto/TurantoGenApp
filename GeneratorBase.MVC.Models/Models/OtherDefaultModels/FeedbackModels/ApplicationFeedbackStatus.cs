...
{
/// <summary>An application feedback status.</summary>
[Table("tbl_ApplicationFeedbackStatus")]
public class ApplicationFeedbackStatus : EntityDefault
{
    ...
    public virtual ICollection<ApplicationFeedback> associatedapplicationfeedbackstatus
    {
        get;
        set;
    }
