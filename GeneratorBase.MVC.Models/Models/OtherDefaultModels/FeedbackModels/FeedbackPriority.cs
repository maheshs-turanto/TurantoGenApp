...
{
/// <summary>A feedback priority.</summary>
[Table("tbl_FeedbackPriority")]
public class FeedbackPriority : EntityDefault
{
    ...
    public virtual ICollection<ApplicationFeedback> applicationfeedbackpriority
    {
        get;
        set;
    }
