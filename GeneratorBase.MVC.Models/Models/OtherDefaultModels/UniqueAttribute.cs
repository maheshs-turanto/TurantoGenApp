...
/// <summary>Validates whether a value is set in another row at the same column. Does not validate
/// null empty or whitespace strings.</summary>
...
public class UniqueAttribute : ValidationAttribute//, IClientValidatable
{
    ...
    /// <summary>Gets the type of the context.</summary>
    ///
    ...
    /// <summary>Initializes a new instance of <see cref="UniqueAttribute"/>.</summary>
    ///
    /// <param name="contextType">  The type of <see cref="DbContext"/> or
    ///                             <see cref="ObjectContext"/> subclass that will be used to search
    ...
    /// <summary>Validates the value against the matching columns in the other rows of this table.
    /// Note that this method does not validate null or empty strings.</summary>
    ///
    ...
    protected override ValidationResult IsValid(object value, ValidationContext validationContext)
    {
        ...
        using(var dbcontext = (IDisposable)Activator.CreateInstance(_ContextType, new SystemUser(), null,0))
        {
    ...
    //    compareRule.ValidationType = "unique";
    //    compareRule.ValidationParameters.Add("unique", this.error);
