...
{
/// <summary>An email template type.</summary>
[Table("tbl_EmailTemplateType")]
public class EmailTemplateType : EntityDefault
{
    ...
    /// <summary>Gets or sets the associatedemailtemplate.</summary>
    ///
    /// <value>The associatedemailtemplate.</value>
    
    public virtual ICollection<EmailTemplate> associatedemailtemplate
    {
        get;
        set;
    }
