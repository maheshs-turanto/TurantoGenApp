...
{
/// <summary>A condition context.</summary>
public class ConditionContext : DbContext
{
    ...
    protected override void OnModelCreating(DbModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Condition>().HasOptional<DynamicRoleMapping>(p => p.dynamicruleconditions).WithMany(s => s.dynamicruleconditions).HasForeignKey(f => f.DynamicRuleConditionsID).WillCascadeOnDelete(false);
    ...
    /// <summary>The conditions filter.</summary>
    public class ConditionsFilter : IFilter<ConditionContext>
    {
        ...
        public ConditionContext DbContext
        {
            get;
            set;
        }
