                ...
                if (options != null ? options.first : void 0) {
                    if (data.selected && this.is_multiple) {
                        ...
                        if (data.style != undefined)
                            stylespn = "<b class='pull-right' style='" + data.style + ";padding:10px;margin:2px 10px;'></b>";
            ...
            if (this.result_highlight) {
                ...
                if (this.is_multiple) {
                    ...
                    if (item.style != undefined)
                        stylespn = "<b class='pull-right' style='" + item.style + ";padding:10px;margin:2px 10px;'></b>";
