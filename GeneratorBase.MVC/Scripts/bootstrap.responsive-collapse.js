(function ($) {
	$.fn.responsiveCollapse = function(options) {
		var settings = $.extend({
			breakPoint:       768,
			overflowItemText: '<span class="MoreDropdown"><i class="fa fa-bars"></i> More <b class="caret"></b> </span>'
		}, options);
		...
		return this.filter('ul').each(function() {
			...
			var overflowItem = $('<li class="dropdown hidden topmoredrop"><a href="#" class="dropdown-toggle" data-toggle="dropdown">' + settings.overflowItemText + '</a><ul class="dropdown-menu dropdown-menu-right"></ul></li>').appendTo($list);
