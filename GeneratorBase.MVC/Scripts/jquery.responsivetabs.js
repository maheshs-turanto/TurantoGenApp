        ...
        if(tabsHeight > individualTabHeight) {
            ...
            $tabs.each(function() {
                ...
                if(thisTabPos.top > firstTabPos.top) {
                    ...
                    if (!$dropdown.length) {
                        var dropdownMarkup = '<li class="dropdown show responsivetabs-more nav-item">'
                            + '<a id="aextratab" aria-expanded="false" aria-haspopup="true" role="button" data-toggle="dropdown" class="dropdown-toggle nav-link" href="#"><span id="selected"> More</span><span class="caret"></span></a>'
