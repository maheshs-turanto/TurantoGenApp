(function () {
    ...
    AbstractChosen = (function () {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                ...
                if (options != null ? options.first : void 0) {
                    if (data.selected && this.is_multiple) {
                        ...
                        if ($(this.form_field).attr('uipropertyinfo') != undefined && data.value.length > 0) {
                            data.style = $(this.form_field).attr('uipropertyinfo')
                        }
                        stylespn = "";
                        if (data.style != undefined)
                            stylespn = "<b class='pull-right' style='" + data.style + ";padding:10px;margin:0px 20px;'></b>";
                        this.single_set_selected_text(data.text, stylespn);
                    }
                }
            }
            return content;
        ...
        AbstractChosen.prototype.result_add_option = function (option) {
            var classes, style, stylespan = "";
            if (!option.search_match) {
                if (option.value != "GetAll")
                    return '';
            }
            ...
            if (option.style != undefined) {
                stylespan = option.style.cssText !== "" ? "<b class='pull-right' style='" + option.style + ";padding:7px'></b>" : "";
                style = option.style.cssText !== "" ? " style=\"" + option.style + "\"" : "";
            }
            else {
                style = "";
            }
            return "<li title=\"" + title + "\" class=\"" + (classes.join(' ')) + "\"" + " data-option-array-index=\"" + option.array_index + "\">" + option.search_text + stylespan + "</li>";
        };
        ...
        AbstractChosen.prototype.winnow_results = function () {
            ...
            if (_ref.length >= 10) {
                ...
                if (parentDDid != null || parentDDid != undefined) {
                    ...
                    for (var i = 0; i < Parents.length; i++) {
                        ...
                        if (type == "hidden") {
                            ...
                            if ($("option:selected", $("select#" + Parents[i])).val() != null && $("option:selected", $("select#" + Parents[i])).val().length > 0) {
                                AssociationNameWithParent = AssociationNames.split(",")[i];
                ...
                if (searchText.length > 0)
                    urlGetAll = addParameterToURL(urlGetAll, 'searchString', searchText);
                ...
                if (UserDropDown != "UserDropDown") {
                    var getAll = {
                        ...
                        value: "GetAll",
                        text: "Get all items",
                        html: "<a class='nohref' title='View All' onclick=\"" + "OpenPopUpBulkOperation('PopupBulkOperation','" + hostingentity + "','" + dispName + "','dvPopupBulkOperation','" + urlGetAll + "')\">View All</a>",
                        selected: false,
                        disabled: true,
                    ...
                    if (!(option.group && !this.group_search)) {
                        ...
                        if (option.search_match) {
                            if (searchText.length) {
                                if (option.search_text.includes("OpenPopUpBulkOperation") && option.search_text.includes("</a>"))
                                    continue;
        ...
        AbstractChosen.prototype.get_single_html = function () {
            return "<a class=\"chosen-single chosen-default\">\n  <span>" + this.default_text + "</span>\n  <div><b></b></div>\n</a>\n<div class=\"chosen-drop\">\n  <div class=\"chosen-search\">\n    <input class=\"chosen-search-input\" type=\"text\" placeholder=\"Search\" autocomplete=\"off\" />\n  </div>\n  <ul class=\"chosen-results\"></ul>\n</div>";
        };

        AbstractChosen.prototype.get_multi_html = function () {
            return "<ul class=\"chosen-choices\">\n  <li class=\"search-field\">\n    <input class=\"chosen-search-input\" type=\"text\" autocomplete=\"off\" placeholder=\"Search\" value=\"" + this.default_text + "\" />\n  </li>\n</ul>\n<div class=\"chosen-drop\">\n  <ul class=\"chosen-results\"></ul>\n</div>";
        };
    ...
    Chosen = (function (_super) {
        ...
        Chosen.prototype.set_up_html = function () {
            ...
            var minwidth = $("#" + this.form_field.id).attr("minwidth") != undefined ? ("position:absolute;z-index:19;width:inherit;min-width:" + $("#" + this.form_field.id).attr("minwidth") + ";") : "width: 100%;";
            container_props = {
            ...
            if (this.is_multiple) {
                this.container.html('<ul class="chosen-choices"><li class="search-field"><input type="text"  value="' + this.default_text + '" class="default" autocomplete="off" placeholder=\"Search\" style="width:25px;" /></li></ul><div class="chosen-drop"><ul class="chosen-results"></ul></div>');
            } else {
                this.container.html('<a class="chosen-single chosen-default" tabindex="-1"><span>' + this.default_text + '</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" placeholder=\"Search\" autocomplete="off" /></div><ul class="chosen-results"></ul></div>');
            }
        ...
        Chosen.prototype.result_select = function (evt) {
            var high, item, selected_index, stylespn;
            if (this.result_highlight) {
                ...
                if (this.is_multiple) {
                    ...
                    if (item.style != undefined)
                        stylespn = "<b class='pull-right' style='" + item.style + ";padding:10px;margin:0px 20px;'></b>";
                    this.single_set_selected_text(item.text, stylespn)
                    //
                    var hostingentity = this.container[0].id.substr(0, this.container[0].id.length - 7);
                    var linktoentName = $("#" + hostingentity).attr("hostingname");
                    if ($("#dvLinkTo" + linktoentName).attr("Id") != undefined) {
        ...
        Chosen.prototype.single_set_selected_text = function (text, style) {
            var stylespan = "";
            if (text == null) {
            ...
            if (text === this.default_text) {
                ...
                this.selected_item.after().find(".pull-right").remove()
            }
            if (style == undefined)
                return this.selected_item.find("span").text(text).attr('title', text);
            return this.selected_item.find("span").text(text).attr('title', text).after(style);
        };
        ...
        Chosen.prototype.keydown_checker = function (evt) {
            ...
            switch (stroke) {
                ...
                case 9:
                    ...
                    try {
                        var cmbid = this.container[0].id.substr(0, this.container[0].id.length - 7);
                        var inlinegrid = undefined;
                        ...
                        var extreme = false;
                        if (evt.shiftKey)
                            inlinegrid = $("#" + cmbid).parent().parent().prevAll('td[onclick*="tdDoubleClick"]', $("#" + cmbid).parent().parent().parent()).first();
                        else
                            inlinegrid = $("#" + cmbid).parent().parent().nextAll('td[onclick*="tdDoubleClick"]', $("#" + cmbid).parent().parent().parent()).first();
                        if (inlinegrid.length > 0 && inlinegrid.attr('onclick').indexOf('tdDoubleClick') > -1) {
                            inlinegrid.click();
                        }
                        else {
                            extreme = true;
                            if (evt.shiftKey)
                                inlinegrid = $('td[onclick*="tdDoubleClick"]', $("#" + cmbid).parent().parent().parent()).last();
                            else inlinegrid = $('td[onclick*="tdDoubleClick"]', $("#" + cmbid).parent().parent().parent()).first();
                            inlinegrid.click();
                        }
                        if (inlinegrid != undefined) {
                            var firstControl = inlinegrid.find(':first');
                            if (firstControl.hasClass('ChosenWrapper')) {
                                var table = $("#" + cmbid).closest('#Des_Table');
...
function select(hostingentity, searchtxt) {
    ...
    if (lock != undefined && lock == "true")
        return stufflist;
    //For Verb
    var VerbEntityName = $("#" + hostingentity).attr('VerbEntityName');
    var VerbTypeID = $("#" + hostingentity).attr('VerbTypeId');
    if (VerbEntityName != undefined)
        VerbEntityName = $("#" + VerbEntityName).val()
    if (VerbTypeID != undefined)
        VerbTypeID = $("#" + VerbTypeID).val()
    //
    ...
    if (parentDDid != null || parentDDid != undefined) {
        ...
        for (var i = 0; i < Parents.length; i++) {
            ...
            if (type == "hidden") {
                ...
                if ($("option:selected", $("select#" + Parents[i])).val() != null && $("option:selected", $("select#" + Parents[i])).val().length > 0) {
                    AssociationNameWithParent = AssociationNames.split(",")[i];
                    selectedParentVal = $("option:selected", $("select#" + Parents[i])).val();
                    if ($("select#" + Parents[i]).attr('multiple') != undefined)
                        selectedParentVal = $("select#" + Parents[i]).val();
                    parent = Parents[i];
                }
            }
        ...
        if (IsReverse == "true" || IsReverse == "True") {
            ...
            if (Parents.length > 1) {
                for (var i = 0; i < Parents.length; i++) {
                    var attrParent = Parents[i];
                    if (typeof attrParent !== typeof undefined && attrParent !== false) {
                        if ($('#' + attrParent).prop('required')) {
                            if ($('#' + attrParent).val().length > 0) {
                                $('#' + hostingentity + '_chosen').find('.chosen-drop').css("visibility", "visible");
                            } else {
                                $('#' + hostingentity + '_chosen').find('.chosen-drop').css("visibility", "hidden");
                            }
                        }
                    }
                }
                ...
                var attrParent = $('#' + hostingentity).attr("ParentDD");
                if (typeof attrParent !== typeof undefined && attrParent !== false) {
                    if ($('#' + attrParent).prop('required')) {
                        if ($('#' + attrParent).val().length > 0) {
                            $('#' + hostingentity + '_chosen').find('.chosen-drop').css("visibility", "visible");
    ...
    finalUrl = addParameterToURL(finalUrl, 'ExtraVal', selectedval);
    if (VerbEntityName != undefined)
        finalUrl = addParameterToURL(finalUrl, "VerbEntityName", VerbEntityName);
    if (VerbTypeID != undefined)
        finalUrl = addParameterToURL(finalUrl, "VerbTypeID", VerbTypeID);
    ...
    if ($inptextarea.length > 0) {
        $inptextarea.focus(function () {
            if (!($(this).hasClass('note-codable'))) {
                var txtareastyle = "padding:2px 5px !important;font-size: 0.9rem!important;z-index: 889; height:90px";
